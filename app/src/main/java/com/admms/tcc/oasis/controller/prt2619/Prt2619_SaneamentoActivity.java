...
public class Prt2619_SaneamentoActivity extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        r_p1.setOnCheckedChangeListener(new RadioGroup.OnCheckedChangeListener() {
            ...
            public void onCheckedChanged(RadioGroup radioGroup, int i) {
                RadioButton na_p1 = (RadioButton) findViewById(R.id.saneamento_p1_na);
                RadioButton ad_p1 = (RadioButton) findViewById(R.id.saneamento_p1_ad);
                RadioButton in_p1 = (RadioButton) findViewById(R.id.saneamento_p1_in);

                ImageButton foto_p1 = (ImageButton) findViewById(R.id.saneamento_foto_p1);
                ImageButton descricao_p1 = (ImageButton) findViewById(R.id.saneamento_descricao_p1);
        ...
        r_p2.setOnCheckedChangeListener(new RadioGroup.OnCheckedChangeListener() {
            @Override
            public void onCheckedChanged(RadioGroup radioGroup, int i) {
                RadioButton na_p2 = (RadioButton) findViewById(R.id.saneamento_p2_na);
                RadioButton ad_p2 = (RadioButton) findViewById(R.id.saneamento_p2_ad);
                RadioButton in_p2 = (RadioButton) findViewById(R.id.saneamento_p2_in);

                ImageButton foto_p2 = (ImageButton) findViewById(R.id.saneamento_foto_p2);
                ImageButton descricao_p2 = (ImageButton) findViewById(R.id.saneamento_descricao_p2);
        ...
        r_p3.setOnCheckedChangeListener(new RadioGroup.OnCheckedChangeListener() {
            @Override
            public void onCheckedChanged(RadioGroup radioGroup, int i) {
                RadioButton na_p3 = (RadioButton) findViewById(R.id.saneamento_p3_na);
                RadioButton ad_p3 = (RadioButton) findViewById(R.id.saneamento_p3_ad);
                RadioButton in_p3 = (RadioButton) findViewById(R.id.saneamento_p3_in);

                ImageButton foto_p3 = (ImageButton) findViewById(R.id.saneamento_foto_p3);
                ImageButton descricao_p3 = (ImageButton) findViewById(R.id.saneamento_descricao_p3);
        ...
        r_p4.setOnCheckedChangeListener(new RadioGroup.OnCheckedChangeListener() {
            @Override
            public void onCheckedChanged(RadioGroup radioGroup, int i) {
                RadioButton na_p4 = (RadioButton) findViewById(R.id.saneamento_p4_na);
                RadioButton ad_p4 = (RadioButton) findViewById(R.id.saneamento_p4_ad);
                RadioButton in_p4 = (RadioButton) findViewById(R.id.saneamento_p4_in);

                ImageButton foto_p4 = (ImageButton) findViewById(R.id.saneamento_foto_p4);
                ImageButton descricao_p4 = (ImageButton) findViewById(R.id.saneamento_descricao_p4);
        ...
        r_p5.setOnCheckedChangeListener(new RadioGroup.OnCheckedChangeListener() {
            @Override
            public void onCheckedChanged(RadioGroup radioGroup, int i) {
                RadioButton na_p5 = (RadioButton) findViewById(R.id.saneamento_p5_na);
                RadioButton ad_p5 = (RadioButton) findViewById(R.id.saneamento_p5_ad);
                RadioButton in_p5 = (RadioButton) findViewById(R.id.saneamento_p5_in);

                ImageButton foto_p5 = (ImageButton) findViewById(R.id.saneamento_foto_p5);
                ImageButton descricao_p5 = (ImageButton) findViewById(R.id.saneamento_descricao_p5);
        ...
        r_p6.setOnCheckedChangeListener(new RadioGroup.OnCheckedChangeListener() {
            @Override
            public void onCheckedChanged(RadioGroup radioGroup, int i) {
                RadioButton na_p6 = (RadioButton) findViewById(R.id.saneamento_p6_na);
                RadioButton ad_p6 = (RadioButton) findViewById(R.id.saneamento_p6_ad);
                RadioButton in_p6 = (RadioButton) findViewById(R.id.saneamento_p6_in);

                ImageButton foto_p6 = (ImageButton) findViewById(R.id.saneamento_foto_p6);
                ImageButton descricao_p6 = (ImageButton) findViewById(R.id.saneamento_descricao_p6);
        ...
        r_p7.setOnCheckedChangeListener(new RadioGroup.OnCheckedChangeListener() {
            @Override
            public void onCheckedChanged(RadioGroup radioGroup, int i) {
                RadioButton na_p7 = (RadioButton) findViewById(R.id.saneamento_p7_na);
                RadioButton ad_p7 = (RadioButton) findViewById(R.id.saneamento_p7_ad);
                RadioButton in_p7 = (RadioButton) findViewById(R.id.saneamento_p7_in);

                ImageButton foto_p7 = (ImageButton) findViewById(R.id.saneamento_foto_p7);
                ImageButton descricao_p7 = (ImageButton) findViewById(R.id.saneamento_descricao_p7);
        ...
        r_p8.setOnCheckedChangeListener(new RadioGroup.OnCheckedChangeListener() {
            @Override
            public void onCheckedChanged(RadioGroup radioGroup, int i) {
                RadioButton na_p8 = (RadioButton) findViewById(R.id.saneamento_p8_na);
                RadioButton ad_p8 = (RadioButton) findViewById(R.id.saneamento_p8_ad);
                RadioButton in_p8 = (RadioButton) findViewById(R.id.saneamento_p8_in);

                ImageButton foto_p8 = (ImageButton) findViewById(R.id.saneamento_foto_p8);
                ImageButton descricao_p8 = (ImageButton) findViewById(R.id.saneamento_descricao_p8);
        ...
        r_p9.setOnCheckedChangeListener(new RadioGroup.OnCheckedChangeListener() {
            @Override
            public void onCheckedChanged(RadioGroup radioGroup, int i) {
                RadioButton na_p9 = (RadioButton) findViewById(R.id.saneamento_p9_na);
                RadioButton ad_p9 = (RadioButton) findViewById(R.id.saneamento_p9_ad);
                RadioButton in_p9 = (RadioButton) findViewById(R.id.saneamento_p9_in);

                ImageButton foto_p9 = (ImageButton) findViewById(R.id.saneamento_foto_p9);
                ImageButton descricao_p9 = (ImageButton) findViewById(R.id.saneamento_descricao_p9);
        ...
        r_p10.setOnCheckedChangeListener(new RadioGroup.OnCheckedChangeListener() {
            @Override
            public void onCheckedChanged(RadioGroup radioGroup, int i) {
                RadioButton na_p10 = (RadioButton) findViewById(R.id.saneamento_p10_na);
                RadioButton ad_p10= (RadioButton) findViewById(R.id.saneamento_p10_ad);
                RadioButton in_p10 = (RadioButton) findViewById(R.id.saneamento_p10_in);

                ImageButton foto_p10 = (ImageButton) findViewById(R.id.saneamento_foto_p10);
                ImageButton descricao_p10 = (ImageButton) findViewById(R.id.saneamento_descricao_p10);
        ...
        r_p11.setOnCheckedChangeListener(new RadioGroup.OnCheckedChangeListener() {
            @Override
            public void onCheckedChanged(RadioGroup radioGroup, int i) {
                RadioButton na_p11 = (RadioButton) findViewById(R.id.saneamento_p11_na);
                RadioButton ad_p11 = (RadioButton) findViewById(R.id.saneamento_p11_ad);
                RadioButton in_p11 = (RadioButton) findViewById(R.id.saneamento_p11_in);

                ImageButton foto_p11 = (ImageButton) findViewById(R.id.saneamento_foto_p11);
                ImageButton descricao_p11 = (ImageButton) findViewById(R.id.saneamento_descricao_p11);
        ...
        r_p12.setOnCheckedChangeListener(new RadioGroup.OnCheckedChangeListener() {
            @Override
            public void onCheckedChanged(RadioGroup radioGroup, int i) {
                RadioButton na_p12 = (RadioButton) findViewById(R.id.saneamento_p12_na);
                RadioButton ad_p12 = (RadioButton) findViewById(R.id.saneamento_p12_ad);
                RadioButton in_p12 = (RadioButton) findViewById(R.id.saneamento_p12_in);

                ImageButton foto_p12 = (ImageButton) findViewById(R.id.saneamento_foto_p12);
                ImageButton descricao_p12 = (ImageButton) findViewById(R.id.saneamento_descricao_p12);
        ...
        r_p13.setOnCheckedChangeListener(new RadioGroup.OnCheckedChangeListener() {
            @Override
            public void onCheckedChanged(RadioGroup radioGroup, int i) {
                RadioButton na_p13 = (RadioButton) findViewById(R.id.saneamento_p13_na);
                RadioButton ad_p13 = (RadioButton) findViewById(R.id.saneamento_p13_ad);
                RadioButton in_p13 = (RadioButton) findViewById(R.id.saneamento_p13_in);

                ImageButton foto_p13 = (ImageButton) findViewById(R.id.saneamento_foto_p13);
                ImageButton descricao_p13 = (ImageButton) findViewById(R.id.saneamento_descricao_p13);
        ...
        r_p14.setOnCheckedChangeListener(new RadioGroup.OnCheckedChangeListener() {
            @Override
            public void onCheckedChanged(RadioGroup radioGroup, int i) {
                RadioButton na_p14 = (RadioButton) findViewById(R.id.saneamento_p14_na);
                RadioButton ad_p14 = (RadioButton) findViewById(R.id.saneamento_p14_ad);
                RadioButton in_p14 = (RadioButton) findViewById(R.id.saneamento_p14_in);

                ImageButton foto_p14 = (ImageButton) findViewById(R.id.saneamento_foto_p14);
                ImageButton descricao_p14 = (ImageButton) findViewById(R.id.saneamento_descricao_p14);
        ...
        r_p15.setOnCheckedChangeListener(new RadioGroup.OnCheckedChangeListener() {
            @Override
            public void onCheckedChanged(RadioGroup radioGroup, int i) {
                RadioButton na_p15 = (RadioButton) findViewById(R.id.saneamento_p15_na);
                RadioButton ad_p15 = (RadioButton) findViewById(R.id.saneamento_p15_ad);
                RadioButton in_p15 = (RadioButton) findViewById(R.id.saneamento_p15_in);

                ImageButton foto_p15 = (ImageButton) findViewById(R.id.saneamento_foto_p15);
                ImageButton descricao_p15 = (ImageButton) findViewById(R.id.saneamento_descricao_p15);
        ...
        r_p16.setOnCheckedChangeListener(new RadioGroup.OnCheckedChangeListener() {
            @Override
            public void onCheckedChanged(RadioGroup radioGroup, int i) {
                RadioButton na_p16 = (RadioButton) findViewById(R.id.saneamento_p16_na);
                RadioButton ad_p16 = (RadioButton) findViewById(R.id.saneamento_p16_ad);
                RadioButton in_p16 = (RadioButton) findViewById(R.id.saneamento_p16_in);

                ImageButton foto_p16 = (ImageButton) findViewById(R.id.saneamento_foto_p16);
                ImageButton descricao_p16 = (ImageButton) findViewById(R.id.saneamento_descricao_p16);
        ...
        r_p17.setOnCheckedChangeListener(new RadioGroup.OnCheckedChangeListener() {
            @Override
            public void onCheckedChanged(RadioGroup radioGroup, int i) {
                RadioButton na_p17 = (RadioButton) findViewById(R.id.saneamento_p17_na);
                RadioButton ad_p17 = (RadioButton) findViewById(R.id.saneamento_p17_ad);
                RadioButton in_p17 = (RadioButton) findViewById(R.id.saneamento_p17_in);

                ImageButton foto_p17 = (ImageButton) findViewById(R.id.saneamento_foto_p17);
                ImageButton descricao_p17 = (ImageButton) findViewById(R.id.saneamento_descricao_p17);
        ...
        saneamentoSalvar.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent intentVaiProSaneamento = new Intent(Prt2619_SaneamentoActivity.this, Prt2619Activity.class);
    ...
    protected void mostraJanelaDescricao() {
        ...
        LayoutInflater layoutInflater = LayoutInflater.from(Prt2619_SaneamentoActivity.this);
        View promptView = layoutInflater.inflate(R.layout.activity_pop_up, null);
        AlertDialog.Builder alertDialogBuilder = new AlertDialog.Builder(Prt2619_SaneamentoActivity.this);
