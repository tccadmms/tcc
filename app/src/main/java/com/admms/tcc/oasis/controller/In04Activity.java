    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        armazenamento.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Intent intentVaiProArmazenamento = new Intent(In04Activity.this, ArmazenamentoActivity.class);
        ...
        documentacao.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent intentVaiPraDocumentacao = new Intent(In04Activity.this, DocumentacaoActivity.class);
        ...
        edificacao.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent intentVaiPraEdificacao = new Intent(In04Activity.this, EdificacaoActivity.class);
        ...
        higiene.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent intentVaiPraHigiene = new Intent(In04Activity.this, HigieneActivity.class);
        ...
        ingredientes.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent intentVaiPraIngredientes = new Intent(In04Activity.this, IngredientesActivity.class);
        ...
        manipulador.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent intentVaiPraManipulador = new Intent(In04Activity.this, ManipuladorActivity.class);
        ...
        vetores.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent intentVaiPraVetores = new Intent(In04Activity.this, VetoresActivity.class);
        ...
        preparo.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent intentVaiPraPreparo = new Intent(In04Activity.this, PreparoActivity.class);
        ...
        residuos.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent intentVaiPraResiduos = new Intent(In04Activity.this, ResiduosActivity.class);
        ...
        responsavel.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent intentVaiPraResponsavel = new Intent(In04Activity.this, ResponsavelActivity.class);
        ...
        saneamento.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent intentVaiPraSaneamento = new Intent(In04Activity.this, SaneamentoActivity.class);
