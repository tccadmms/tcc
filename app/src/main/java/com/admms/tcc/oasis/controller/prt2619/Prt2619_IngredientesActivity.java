...
public class Prt2619_IngredientesActivity extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        r_p18.setOnCheckedChangeListener(new RadioGroup.OnCheckedChangeListener() {
            @Override
            public void onCheckedChanged(RadioGroup radioGroup, int i) {
                RadioButton na_p18 = (RadioButton) findViewById(R.id.ingredientes_p18_na);
                RadioButton ad_p18 = (RadioButton) findViewById(R.id.ingredientes_p18_ad);
                RadioButton in_p18 = (RadioButton) findViewById(R.id.ingredientes_p18_in);

                ImageButton foto_p18 = (ImageButton) findViewById(R.id.ingredientes_foto_p18);
                ImageButton descricao_p18 = (ImageButton) findViewById(R.id.ingredientes_descricao_p18);
