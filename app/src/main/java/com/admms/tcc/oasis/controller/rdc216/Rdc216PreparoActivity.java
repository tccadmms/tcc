...
public class Rdc216PreparoActivity extends Activity {
    ...
    r_p24.setOnCheckedChangeListener(new RadioGroup.OnCheckedChangeListener() {
        ...
        preparoSalvar.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent intentVaiProPreparo = new Intent(Rdc216PreparoActivity.this, Rdc216Activity.class);
    ...
    protected void mostraJanelaDescricao() {
        ...
        LayoutInflater layoutInflater = LayoutInflater.from(Rdc216PreparoActivity.this);
        View promptView = layoutInflater.inflate(R.layout.activity_pop_up, null);
        AlertDialog.Builder alertDialogBuilder = new AlertDialog.Builder(Rdc216PreparoActivity.this);
