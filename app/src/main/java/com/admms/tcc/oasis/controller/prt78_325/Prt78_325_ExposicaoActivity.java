...
public class Prt78_325_ExposicaoActivity extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        exposicaoSalvar.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                List<ItemAvaliacao> listaItens = ItemAvaliacaoController.buscaItemAvaliacaoPorAreaAvaliada(planoAcao,Constantes.AREA_AVALIADA_EXPOSICAO, Prt78_325_ExposicaoActivity.this);
                ...
                if (NUMERO_PERGUNTAS != listaItens.size()) {
                    ...
                    AlertDialog.Builder builder = new AlertDialog.Builder(Prt78_325_ExposicaoActivity.this);
    ...
    protected void mostraJanelaDescricao(final ItemAvaliacao itemAvaliacao) {
        ...
        AlertDialog.Builder alertDialogBuilder = new AlertDialog.Builder(Prt78_325_ExposicaoActivity.this);
