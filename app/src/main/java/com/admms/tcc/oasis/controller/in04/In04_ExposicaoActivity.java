...
public class In04_ExposicaoActivity extends Activity {
    ...
    private static final int NUMERO_PERGUNTAS = 9;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        final Context context = In04_ExposicaoActivity.this;
                        ...
                        public void onClick(DialogInterface dialog, int which) {
                            switch (which){
                                case DialogInterface.BUTTON_POSITIVE:
                                    Intent intentVaiProExposicao = new Intent(context, In04Activity.class);
