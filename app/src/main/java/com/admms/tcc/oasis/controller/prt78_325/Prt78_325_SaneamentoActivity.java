    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        r_p1.setOnCheckedChangeListener(new RadioGroup.OnCheckedChangeListener() {
            ...
            public void onCheckedChanged(RadioGroup radioGroup, int i) {
                ...
                ItemAvaliacaoController.salvarItemAvaliacao(itemAvaliacao, Prt78_325_SaneamentoActivity.this);
            }
        });
        ...
        saneamentoSalvar.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                List<ItemAvaliacao> listaItens = ItemAvaliacaoController.buscaItemAvaliacaoPorAreaAvaliada(planoAcao,Constantes.AREA_AVALIADA_SANEAMENTO, Prt78_325_SaneamentoActivity.this);
                ...
                if (NUMERO_PERGUNTAS != listaItens.size()) {
                    ...
                    AlertDialog.Builder builder = new AlertDialog.Builder(Prt78_325_SaneamentoActivity.this);
