...
public class Prt2619_PreparoActivity extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        r_p1.setOnCheckedChangeListener(new RadioGroup.OnCheckedChangeListener() {
            ...
            public void onCheckedChanged(RadioGroup radioGroup, int i) {
                RadioButton na_p1 = (RadioButton) findViewById(R.id.preparo_p1_na);
                RadioButton ad_p1 = (RadioButton) findViewById(R.id.preparo_p1_ad);
                RadioButton in_p1 = (RadioButton) findViewById(R.id.preparo_p1_in);

                ImageButton foto_p1 = (ImageButton) findViewById(R.id.preparo_foto_p1);
                ImageButton descricao_p1 = (ImageButton) findViewById(R.id.preparo_descricao_p1);
        ...
        r_p2.setOnCheckedChangeListener(new RadioGroup.OnCheckedChangeListener() {
            @Override
            public void onCheckedChanged(RadioGroup radioGroup, int i) {
                RadioButton na_p2 = (RadioButton) findViewById(R.id.preparo_p2_na);
                RadioButton ad_p2 = (RadioButton) findViewById(R.id.preparo_p2_ad);
                RadioButton in_p2 = (RadioButton) findViewById(R.id.preparo_p2_in);

                ImageButton foto_p2 = (ImageButton) findViewById(R.id.preparo_foto_p2);
                ImageButton descricao_p2 = (ImageButton) findViewById(R.id.preparo_descricao_p2);
        ...
        r_p3.setOnCheckedChangeListener(new RadioGroup.OnCheckedChangeListener() {
            @Override
            public void onCheckedChanged(RadioGroup radioGroup, int i) {
                RadioButton na_p3 = (RadioButton) findViewById(R.id.preparo_p3_na);
                RadioButton ad_p3 = (RadioButton) findViewById(R.id.preparo_p3_ad);
                RadioButton in_p3 = (RadioButton) findViewById(R.id.preparo_p3_in);

                ImageButton foto_p3 = (ImageButton) findViewById(R.id.preparo_foto_p3);
                ImageButton descricao_p3 = (ImageButton) findViewById(R.id.preparo_descricao_p3);
        ...
        r_p4.setOnCheckedChangeListener(new RadioGroup.OnCheckedChangeListener() {
            @Override
            public void onCheckedChanged(RadioGroup radioGroup, int i) {
                RadioButton na_p4 = (RadioButton) findViewById(R.id.preparo_p4_na);
                RadioButton ad_p4 = (RadioButton) findViewById(R.id.preparo_p4_ad);
                RadioButton in_p4 = (RadioButton) findViewById(R.id.preparo_p4_in);

                ImageButton foto_p4 = (ImageButton) findViewById(R.id.preparo_foto_p4);
                ImageButton descricao_p4 = (ImageButton) findViewById(R.id.preparo_descricao_p4);
        ...
        r_p5.setOnCheckedChangeListener(new RadioGroup.OnCheckedChangeListener() {
            @Override
            public void onCheckedChanged(RadioGroup radioGroup, int i) {
                RadioButton na_p5 = (RadioButton) findViewById(R.id.preparo_p5_na);
                RadioButton ad_p5 = (RadioButton) findViewById(R.id.preparo_p5_ad);
                RadioButton in_p5 = (RadioButton) findViewById(R.id.preparo_p5_in);

                ImageButton foto_p5 = (ImageButton) findViewById(R.id.preparo_foto_p5);
                ImageButton descricao_p5 = (ImageButton) findViewById(R.id.preparo_descricao_p5);
        ...
        r_p6.setOnCheckedChangeListener(new RadioGroup.OnCheckedChangeListener() {
            @Override
            public void onCheckedChanged(RadioGroup radioGroup, int i) {
                RadioButton na_p6 = (RadioButton) findViewById(R.id.preparo_p6_na);
                RadioButton ad_p6 = (RadioButton) findViewById(R.id.preparo_p6_ad);
                RadioButton in_p6 = (RadioButton) findViewById(R.id.preparo_p6_in);

                ImageButton foto_p6 = (ImageButton) findViewById(R.id.preparo_foto_p6);
                ImageButton descricao_p6 = (ImageButton) findViewById(R.id.preparo_descricao_p6);
        ...
        r_p7.setOnCheckedChangeListener(new RadioGroup.OnCheckedChangeListener() {
            @Override
            public void onCheckedChanged(RadioGroup radioGroup, int i) {
                RadioButton na_p7 = (RadioButton) findViewById(R.id.preparo_p7_na);
                RadioButton ad_p7 = (RadioButton) findViewById(R.id.preparo_p7_ad);
                RadioButton in_p7 = (RadioButton) findViewById(R.id.preparo_p7_in);

                ImageButton foto_p7 = (ImageButton) findViewById(R.id.preparo_foto_p7);
                ImageButton descricao_p7 = (ImageButton) findViewById(R.id.preparo_descricao_p7);
        ...
        r_p8.setOnCheckedChangeListener(new RadioGroup.OnCheckedChangeListener() {
            @Override
            public void onCheckedChanged(RadioGroup radioGroup, int i) {
                RadioButton na_p8 = (RadioButton) findViewById(R.id.preparo_p8_na);
                RadioButton ad_p8 = (RadioButton) findViewById(R.id.preparo_p8_ad);
                RadioButton in_p8 = (RadioButton) findViewById(R.id.preparo_p8_in);

                ImageButton foto_p8 = (ImageButton) findViewById(R.id.preparo_foto_p8);
                ImageButton descricao_p8 = (ImageButton) findViewById(R.id.preparo_descricao_p8);
        ...
        r_p9.setOnCheckedChangeListener(new RadioGroup.OnCheckedChangeListener() {
            @Override
            public void onCheckedChanged(RadioGroup radioGroup, int i) {
                RadioButton na_p9 = (RadioButton) findViewById(R.id.preparo_p9_na);
                RadioButton ad_p9 = (RadioButton) findViewById(R.id.preparo_p9_ad);
                RadioButton in_p9 = (RadioButton) findViewById(R.id.preparo_p9_in);

                ImageButton foto_p9 = (ImageButton) findViewById(R.id.preparo_foto_p9);
                ImageButton descricao_p9 = (ImageButton) findViewById(R.id.preparo_descricao_p9);
        ...
        r_p10.setOnCheckedChangeListener(new RadioGroup.OnCheckedChangeListener() {
            @Override
            public void onCheckedChanged(RadioGroup radioGroup, int i) {
                RadioButton na_p10 = (RadioButton) findViewById(R.id.preparo_p10_na);
                RadioButton ad_p10= (RadioButton) findViewById(R.id.preparo_p10_ad);
                RadioButton in_p10 = (RadioButton) findViewById(R.id.preparo_p10_in);

                ImageButton foto_p10 = (ImageButton) findViewById(R.id.preparo_foto_p10);
                ImageButton descricao_p10 = (ImageButton) findViewById(R.id.preparo_descricao_p10);
        ...
        r_p11.setOnCheckedChangeListener(new RadioGroup.OnCheckedChangeListener() {
            @Override
            public void onCheckedChanged(RadioGroup radioGroup, int i) {
                RadioButton na_p11 = (RadioButton) findViewById(R.id.preparo_p11_na);
                RadioButton ad_p11 = (RadioButton) findViewById(R.id.preparo_p11_ad);
                RadioButton in_p11 = (RadioButton) findViewById(R.id.preparo_p11_in);

                ImageButton foto_p11 = (ImageButton) findViewById(R.id.preparo_foto_p11);
                ImageButton descricao_p11 = (ImageButton) findViewById(R.id.preparo_descricao_p11);
        ...
        r_p12.setOnCheckedChangeListener(new RadioGroup.OnCheckedChangeListener() {
            @Override
            public void onCheckedChanged(RadioGroup radioGroup, int i) {
                RadioButton na_p12 = (RadioButton) findViewById(R.id.preparo_p12_na);
                RadioButton ad_p12 = (RadioButton) findViewById(R.id.preparo_p12_ad);
                RadioButton in_p12 = (RadioButton) findViewById(R.id.preparo_p12_in);

                ImageButton foto_p12 = (ImageButton) findViewById(R.id.preparo_foto_p12);
                ImageButton descricao_p12 = (ImageButton) findViewById(R.id.preparo_descricao_p12);
        ...
        r_p13.setOnCheckedChangeListener(new RadioGroup.OnCheckedChangeListener() {
            @Override
            public void onCheckedChanged(RadioGroup radioGroup, int i) {
                RadioButton na_p13 = (RadioButton) findViewById(R.id.preparo_p13_na);
                RadioButton ad_p13 = (RadioButton) findViewById(R.id.preparo_p13_ad);
                RadioButton in_p13 = (RadioButton) findViewById(R.id.preparo_p13_in);

                ImageButton foto_p13 = (ImageButton) findViewById(R.id.preparo_foto_p13);
                ImageButton descricao_p13 = (ImageButton) findViewById(R.id.preparo_descricao_p13);
        ...
        r_p14.setOnCheckedChangeListener(new RadioGroup.OnCheckedChangeListener() {
            @Override
            public void onCheckedChanged(RadioGroup radioGroup, int i) {
                RadioButton na_p14 = (RadioButton) findViewById(R.id.preparo_p14_na);
                RadioButton ad_p14 = (RadioButton) findViewById(R.id.preparo_p14_ad);
                RadioButton in_p14 = (RadioButton) findViewById(R.id.preparo_p14_in);

                ImageButton foto_p14 = (ImageButton) findViewById(R.id.preparo_foto_p14);
                ImageButton descricao_p14 = (ImageButton) findViewById(R.id.preparo_descricao_p14);
        ...
        r_p15.setOnCheckedChangeListener(new RadioGroup.OnCheckedChangeListener() {
            @Override
            public void onCheckedChanged(RadioGroup radioGroup, int i) {
                RadioButton na_p15 = (RadioButton) findViewById(R.id.preparo_p15_na);
                RadioButton ad_p15 = (RadioButton) findViewById(R.id.preparo_p15_ad);
                RadioButton in_p15 = (RadioButton) findViewById(R.id.preparo_p15_in);

                ImageButton foto_p15 = (ImageButton) findViewById(R.id.preparo_foto_p15);
                ImageButton descricao_p15 = (ImageButton) findViewById(R.id.preparo_descricao_p15);
        ...
        r_p16.setOnCheckedChangeListener(new RadioGroup.OnCheckedChangeListener() {
            @Override
            public void onCheckedChanged(RadioGroup radioGroup, int i) {
                RadioButton na_p16 = (RadioButton) findViewById(R.id.preparo_p16_na);
                RadioButton ad_p16 = (RadioButton) findViewById(R.id.preparo_p16_ad);
                RadioButton in_p16 = (RadioButton) findViewById(R.id.preparo_p16_in);

                ImageButton foto_p16 = (ImageButton) findViewById(R.id.preparo_foto_p16);
                ImageButton descricao_p16 = (ImageButton) findViewById(R.id.preparo_descricao_p16);
        ...
        r_p17.setOnCheckedChangeListener(new RadioGroup.OnCheckedChangeListener() {
            @Override
            public void onCheckedChanged(RadioGroup radioGroup, int i) {
                RadioButton na_p17 = (RadioButton) findViewById(R.id.preparo_p17_na);
                RadioButton ad_p17 = (RadioButton) findViewById(R.id.preparo_p17_ad);
                RadioButton in_p17 = (RadioButton) findViewById(R.id.preparo_p17_in);

                ImageButton foto_p17 = (ImageButton) findViewById(R.id.preparo_foto_p17);
                ImageButton descricao_p17 = (ImageButton) findViewById(R.id.preparo_descricao_p17);
        ...
        r_p18.setOnCheckedChangeListener(new RadioGroup.OnCheckedChangeListener() {
            @Override
            public void onCheckedChanged(RadioGroup radioGroup, int i) {
                RadioButton na_p18 = (RadioButton) findViewById(R.id.preparo_p18_na);
                RadioButton ad_p18 = (RadioButton) findViewById(R.id.preparo_p18_ad);
                RadioButton in_p18 = (RadioButton) findViewById(R.id.preparo_p18_in);

                ImageButton foto_p18 = (ImageButton) findViewById(R.id.preparo_foto_p18);
                ImageButton descricao_p18 = (ImageButton) findViewById(R.id.preparo_descricao_p18);
        ...
        r_p19.setOnCheckedChangeListener(new RadioGroup.OnCheckedChangeListener() {
            @Override
            public void onCheckedChanged(RadioGroup radioGroup, int i) {
                RadioButton na_p19 = (RadioButton) findViewById(R.id.preparo_p19_na);
                RadioButton ad_p19 = (RadioButton) findViewById(R.id.preparo_p19_ad);
                RadioButton in_p19 = (RadioButton) findViewById(R.id.preparo_p19_in);

                ImageButton foto_p19 = (ImageButton) findViewById(R.id.preparo_foto_p19);
                ImageButton descricao_p19 = (ImageButton) findViewById(R.id.preparo_descricao_p19);
        ...
        r_p20.setOnCheckedChangeListener(new RadioGroup.OnCheckedChangeListener() {
            @Override
            public void onCheckedChanged(RadioGroup radioGroup, int i) {
                RadioButton na_p20 = (RadioButton) findViewById(R.id.preparo_p20_na);
                RadioButton ad_p20 = (RadioButton) findViewById(R.id.preparo_p20_ad);
                RadioButton in_p20 = (RadioButton) findViewById(R.id.preparo_p20_in);

                ImageButton foto_p20 = (ImageButton) findViewById(R.id.preparo_foto_p20);
                ImageButton descricao_p20 = (ImageButton) findViewById(R.id.preparo_descricao_p20);
        ...
        r_p21.setOnCheckedChangeListener(new RadioGroup.OnCheckedChangeListener() {
            @Override
            public void onCheckedChanged(RadioGroup radioGroup, int i) {
                RadioButton na_p21 = (RadioButton) findViewById(R.id.preparo_p21_na);
                RadioButton ad_p21 = (RadioButton) findViewById(R.id.preparo_p21_ad);
                RadioButton in_p21 = (RadioButton) findViewById(R.id.preparo_p21_in);

                ImageButton foto_p21 = (ImageButton) findViewById(R.id.preparo_foto_p21);
                ImageButton descricao_p21 = (ImageButton) findViewById(R.id.preparo_descricao_p21);
        ...
        r_p22.setOnCheckedChangeListener(new RadioGroup.OnCheckedChangeListener() {
            @Override
            public void onCheckedChanged(RadioGroup radioGroup, int i) {
                RadioButton na_p22 = (RadioButton) findViewById(R.id.preparo_p22_na);
                RadioButton ad_p22 = (RadioButton) findViewById(R.id.preparo_p22_ad);
                RadioButton in_p22 = (RadioButton) findViewById(R.id.preparo_p22_in);

                ImageButton foto_p22 = (ImageButton) findViewById(R.id.preparo_foto_p22);
                ImageButton descricao_p22 = (ImageButton) findViewById(R.id.preparo_descricao_p22);
        ...
        r_p23.setOnCheckedChangeListener(new RadioGroup.OnCheckedChangeListener() {
            @Override
            public void onCheckedChanged(RadioGroup radioGroup, int i) {
                RadioButton na_p23 = (RadioButton) findViewById(R.id.preparo_p23_na);
                RadioButton ad_p23 = (RadioButton) findViewById(R.id.preparo_p23_ad);
                RadioButton in_p23 = (RadioButton) findViewById(R.id.preparo_p23_in);

                ImageButton foto_p23 = (ImageButton) findViewById(R.id.preparo_foto_p23);
                ImageButton descricao_p23 = (ImageButton) findViewById(R.id.preparo_descricao_p23);
        ...
        r_p24.setOnCheckedChangeListener(new RadioGroup.OnCheckedChangeListener() {
            @Override
            public void onCheckedChanged(RadioGroup radioGroup, int i) {
                RadioButton na_p24 = (RadioButton) findViewById(R.id.preparo_p24_na);
                RadioButton ad_p24 = (RadioButton) findViewById(R.id.preparo_p24_ad);
                RadioButton in_p24 = (RadioButton) findViewById(R.id.preparo_p24_in);

                ImageButton foto_p24 = (ImageButton) findViewById(R.id.preparo_foto_p24);
                ImageButton descricao_p24 = (ImageButton) findViewById(R.id.preparo_descricao_p24);
        ...
        r_p25.setOnCheckedChangeListener(new RadioGroup.OnCheckedChangeListener() {
            @Override
            public void onCheckedChanged(RadioGroup radioGroup, int i) {
                RadioButton na_p25 = (RadioButton) findViewById(R.id.preparo_p25_na);
                RadioButton ad_p25 = (RadioButton) findViewById(R.id.preparo_p25_ad);
                RadioButton in_p25 = (RadioButton) findViewById(R.id.preparo_p25_in);

                ImageButton foto_p25 = (ImageButton) findViewById(R.id.preparo_foto_p25);
                ImageButton descricao_p25 = (ImageButton) findViewById(R.id.preparo_descricao_p25);
        ...
        r_p26.setOnCheckedChangeListener(new RadioGroup.OnCheckedChangeListener() {
            @Override
            public void onCheckedChanged(RadioGroup radioGroup, int i) {
                RadioButton na_p26 = (RadioButton) findViewById(R.id.preparo_p26_na);
                RadioButton ad_p26 = (RadioButton) findViewById(R.id.preparo_p26_ad);
                RadioButton in_p26 = (RadioButton) findViewById(R.id.preparo_p26_in);

                ImageButton foto_p26 = (ImageButton) findViewById(R.id.preparo_foto_p26);
                ImageButton descricao_p26 = (ImageButton) findViewById(R.id.preparo_descricao_p26);
        ...
        r_p27.setOnCheckedChangeListener(new RadioGroup.OnCheckedChangeListener() {
            @Override
            public void onCheckedChanged(RadioGroup radioGroup, int i) {
                RadioButton na_p27 = (RadioButton) findViewById(R.id.preparo_p27_na);
                RadioButton ad_p27 = (RadioButton) findViewById(R.id.preparo_p27_ad);
                RadioButton in_p27 = (RadioButton) findViewById(R.id.preparo_p27_in);

                ImageButton foto_p27 = (ImageButton) findViewById(R.id.preparo_foto_p27);
                ImageButton descricao_p27 = (ImageButton) findViewById(R.id.preparo_descricao_p27);
        ...
        r_p28.setOnCheckedChangeListener(new RadioGroup.OnCheckedChangeListener() {
            @Override
            public void onCheckedChanged(RadioGroup radioGroup, int i) {
                RadioButton na_p28 = (RadioButton) findViewById(R.id.preparo_p28_na);
                RadioButton ad_p28 = (RadioButton) findViewById(R.id.preparo_p28_ad);
                RadioButton in_p28 = (RadioButton) findViewById(R.id.preparo_p28_in);

                ImageButton foto_p28 = (ImageButton) findViewById(R.id.preparo_foto_p28);
                ImageButton descricao_p28 = (ImageButton) findViewById(R.id.preparo_descricao_p28);
        ...
        r_p29.setOnCheckedChangeListener(new RadioGroup.OnCheckedChangeListener() {
            @Override
            public void onCheckedChanged(RadioGroup radioGroup, int i) {
                RadioButton na_p29 = (RadioButton) findViewById(R.id.preparo_p29_na);
                RadioButton ad_p29 = (RadioButton) findViewById(R.id.preparo_p29_ad);
                RadioButton in_p29 = (RadioButton) findViewById(R.id.preparo_p29_in);

                ImageButton foto_p29 = (ImageButton) findViewById(R.id.preparo_foto_p29);
                ImageButton descricao_p29 = (ImageButton) findViewById(R.id.preparo_descricao_p29);
        ...
        r_p30.setOnCheckedChangeListener(new RadioGroup.OnCheckedChangeListener() {
            @Override
            public void onCheckedChanged(RadioGroup radioGroup, int i) {
                RadioButton na_p30 = (RadioButton) findViewById(R.id.preparo_p30_na);
                RadioButton ad_p30 = (RadioButton) findViewById(R.id.preparo_p30_ad);
                RadioButton in_p30 = (RadioButton) findViewById(R.id.preparo_p30_in);

                ImageButton foto_p30 = (ImageButton) findViewById(R.id.preparo_foto_p30);
                ImageButton descricao_p30 = (ImageButton) findViewById(R.id.preparo_descricao_p30);
        ...
        r_p31.setOnCheckedChangeListener(new RadioGroup.OnCheckedChangeListener() {
            @Override
            public void onCheckedChanged(RadioGroup radioGroup, int i) {
                RadioButton na_p31 = (RadioButton) findViewById(R.id.preparo_p31_na);
                RadioButton ad_p31 = (RadioButton) findViewById(R.id.preparo_p31_ad);
                RadioButton in_p31 = (RadioButton) findViewById(R.id.preparo_p31_in);

                ImageButton foto_p31 = (ImageButton) findViewById(R.id.preparo_foto_p31);
                ImageButton descricao_p31 = (ImageButton) findViewById(R.id.preparo_descricao_p31);
        ...
        r_p32.setOnCheckedChangeListener(new RadioGroup.OnCheckedChangeListener() {
            @Override
            public void onCheckedChanged(RadioGroup radioGroup, int i) {
                RadioButton na_p32 = (RadioButton) findViewById(R.id.preparo_p32_na);
                RadioButton ad_p32 = (RadioButton) findViewById(R.id.preparo_p32_ad);
                RadioButton in_p32 = (RadioButton) findViewById(R.id.preparo_p32_in);

                ImageButton foto_p32 = (ImageButton) findViewById(R.id.preparo_foto_p32);
                ImageButton descricao_p32 = (ImageButton) findViewById(R.id.preparo_descricao_p32);
        ...
        r_p33.setOnCheckedChangeListener(new RadioGroup.OnCheckedChangeListener() {
            @Override
            public void onCheckedChanged(RadioGroup radioGroup, int i) {
                RadioButton na_p33 = (RadioButton) findViewById(R.id.preparo_p33_na);
                RadioButton ad_p33 = (RadioButton) findViewById(R.id.preparo_p33_ad);
                RadioButton in_p33 = (RadioButton) findViewById(R.id.preparo_p33_in);

                ImageButton foto_p33 = (ImageButton) findViewById(R.id.preparo_foto_p33);
                ImageButton descricao_p33 = (ImageButton) findViewById(R.id.preparo_descricao_p33);
        ...
        r_p34.setOnCheckedChangeListener(new RadioGroup.OnCheckedChangeListener() {
            @Override
            public void onCheckedChanged(RadioGroup radioGroup, int i) {
                RadioButton na_p34 = (RadioButton) findViewById(R.id.preparo_p34_na);
                RadioButton ad_p34 = (RadioButton) findViewById(R.id.preparo_p34_ad);
                RadioButton in_p34 = (RadioButton) findViewById(R.id.preparo_p34_in);

                ImageButton foto_p34 = (ImageButton) findViewById(R.id.preparo_foto_p34);
                ImageButton descricao_p34 = (ImageButton) findViewById(R.id.preparo_descricao_p34);
        ...
        r_p35.setOnCheckedChangeListener(new RadioGroup.OnCheckedChangeListener() {
            @Override
            public void onCheckedChanged(RadioGroup radioGroup, int i) {
                RadioButton na_p35 = (RadioButton) findViewById(R.id.preparo_p35_na);
                RadioButton ad_p35 = (RadioButton) findViewById(R.id.preparo_p35_ad);
                RadioButton in_p35 = (RadioButton) findViewById(R.id.preparo_p35_in);

                ImageButton foto_p35 = (ImageButton) findViewById(R.id.preparo_foto_p35);
                ImageButton descricao_p35 = (ImageButton) findViewById(R.id.preparo_descricao_p35);
        ...
        r_p36.setOnCheckedChangeListener(new RadioGroup.OnCheckedChangeListener() {
            @Override
            public void onCheckedChanged(RadioGroup radioGroup, int i) {
                RadioButton na_p36 = (RadioButton) findViewById(R.id.preparo_p36_na);
                RadioButton ad_p36 = (RadioButton) findViewById(R.id.preparo_p36_ad);
                RadioButton in_p36 = (RadioButton) findViewById(R.id.preparo_p36_in);

                ImageButton foto_p36 = (ImageButton) findViewById(R.id.preparo_foto_p36);
                ImageButton descricao_p36 = (ImageButton) findViewById(R.id.preparo_descricao_p36);
        ...
        r_p37.setOnCheckedChangeListener(new RadioGroup.OnCheckedChangeListener() {
            @Override
            public void onCheckedChanged(RadioGroup radioGroup, int i) {
                RadioButton na_p37 = (RadioButton) findViewById(R.id.preparo_p37_na);
                RadioButton ad_p37 = (RadioButton) findViewById(R.id.preparo_p37_ad);
                RadioButton in_p37 = (RadioButton) findViewById(R.id.preparo_p37_in);

                ImageButton foto_p37 = (ImageButton) findViewById(R.id.preparo_foto_p37);
                ImageButton descricao_p37 = (ImageButton) findViewById(R.id.preparo_descricao_p37);
        ...
        preparoSalvar.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent intentVaiProPreparo = new Intent(Prt2619_PreparoActivity.this, Prt2619Activity.class);
    ...
    protected void mostraJanelaDescricao() {
        ...
        LayoutInflater layoutInflater = LayoutInflater.from(Prt2619_PreparoActivity.this);
        View promptView = layoutInflater.inflate(R.layout.activity_pop_up, null);
        AlertDialog.Builder alertDialogBuilder = new AlertDialog.Builder(Prt2619_PreparoActivity.this);
