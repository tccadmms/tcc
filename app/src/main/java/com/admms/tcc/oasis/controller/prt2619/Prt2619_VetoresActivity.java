...
public class Prt2619_VetoresActivity extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        final Context context = Prt2619_VetoresActivity.this;
                        ...
                        public void onClick(DialogInterface dialog, int which) {
                            switch (which){
                                case DialogInterface.BUTTON_POSITIVE:
                                    Intent intentVaiProVetores = new Intent(context, Prt2619Activity.class);
    ...
    private void populateActivity(Context context) {
        ...
        listaRadioButtons.add((RadioButton) findViewById(R.id.vetores_p7_na));
        listaRadioButtons.add((RadioButton) findViewById(R.id.vetores_p7_ad));
        listaRadioButtons.add((RadioButton) findViewById(R.id.vetores_p7_in));
        listaRadioButtons.add((RadioButton) findViewById(R.id.vetores_p8_na));
        listaRadioButtons.add((RadioButton) findViewById(R.id.vetores_p8_ad));
        listaRadioButtons.add((RadioButton) findViewById(R.id.vetores_p8_in));
        ...
        listaImageButtons.add((ImageButton) findViewById(R.id.vetores_foto_p7));
        listaImageButtons.add((ImageButton) findViewById(R.id.vetores_descricao_p7));
        listaImageButtons.add((ImageButton) findViewById(R.id.vetores_foto_p8));
        listaImageButtons.add((ImageButton) findViewById(R.id.vetores_descricao_p8));
        ...
        listaTextViews.add((TextView) findViewById(R.id.vetores_pergunta7));
        listaTextViews.add((TextView) findViewById(R.id.vetores_pergunta8));
