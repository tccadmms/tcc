...
public class Prt2619_SaneamentoActivity extends Activity {

    private ItemAvaliacao itemAvaliacao;
    private static final int NUMERO_PERGUNTAS = 17;

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_prt2619__saneamento);

        final Context context = Prt2619_SaneamentoActivity.this;
        ...
        RadioGroup r_p9 = (RadioGroup) findViewById(R.id.saneamento_p9);
        ...
        r_p9.setOnCheckedChangeListener(new RadioGroup.OnCheckedChangeListener() {
            ...
            public void onCheckedChanged(RadioGroup radioGroup, int i) {
                itemAvaliacao = ItemAvaliacaoController.limpaItemAvaliacao(itemAvaliacao);
                RadioButton na = (RadioButton) findViewById(R.id.saneamento_p9_na);
                RadioButton ad = (RadioButton) findViewById(R.id.saneamento_p9_ad);
                RadioButton in = (RadioButton) findViewById(R.id.saneamento_p9_in);

                ImageButton foto = (ImageButton) findViewById(R.id.saneamento_foto_p9);
                ImageButton descricao = (ImageButton) findViewById(R.id.saneamento_descricao_p9);


                TextView pergunta = (TextView) findViewById(R.id.saneamento_pergunta9);
                itemAvaliacao.setPergunta(pergunta.getText().toString());
                UserInterfaceController.radioButtonHandler(na, ad, in, foto, descricao, itemAvaliacao, context);
                ItemAvaliacaoController.salvarItemAvaliacao(itemAvaliacao, context);
            }
        ...
        RadioGroup r_p10 = (RadioGroup) findViewById(R.id.saneamento_p10);
        ...
        r_p10.setOnCheckedChangeListener(new RadioGroup.OnCheckedChangeListener() {
            ...
            public void onCheckedChanged(RadioGroup radioGroup, int i) {
                itemAvaliacao = ItemAvaliacaoController.limpaItemAvaliacao(itemAvaliacao);
                RadioButton na = (RadioButton) findViewById(R.id.saneamento_p10_na);
                RadioButton ad = (RadioButton) findViewById(R.id.saneamento_p10_ad);
                RadioButton in = (RadioButton) findViewById(R.id.saneamento_p10_in);

                ImageButton foto = (ImageButton) findViewById(R.id.saneamento_foto_p10);
                ImageButton descricao = (ImageButton) findViewById(R.id.saneamento_descricao_p10);


                TextView pergunta = (TextView) findViewById(R.id.saneamento_pergunta10);
                itemAvaliacao.setPergunta(pergunta.getText().toString());
                UserInterfaceController.radioButtonHandler(na, ad, in, foto, descricao, itemAvaliacao, context);
                ItemAvaliacaoController.salvarItemAvaliacao(itemAvaliacao, context);
            }
        ...
        RadioGroup r_p11 = (RadioGroup) findViewById(R.id.saneamento_p11);
        ...
        r_p11.setOnCheckedChangeListener(new RadioGroup.OnCheckedChangeListener() {
            ...
            public void onCheckedChanged(RadioGroup radioGroup, int i) {
                itemAvaliacao = ItemAvaliacaoController.limpaItemAvaliacao(itemAvaliacao);
                RadioButton na = (RadioButton) findViewById(R.id.saneamento_p11_na);
                RadioButton ad = (RadioButton) findViewById(R.id.saneamento_p11_ad);
                RadioButton in = (RadioButton) findViewById(R.id.saneamento_p11_in);

                ImageButton foto = (ImageButton) findViewById(R.id.saneamento_foto_p11);
                ImageButton descricao = (ImageButton) findViewById(R.id.saneamento_descricao_p11);


                TextView pergunta = (TextView) findViewById(R.id.saneamento_pergunta11);
                itemAvaliacao.setPergunta(pergunta.getText().toString());
                UserInterfaceController.radioButtonHandler(na, ad, in, foto, descricao, itemAvaliacao, context);
                ItemAvaliacaoController.salvarItemAvaliacao(itemAvaliacao, context);
            }
        ...
        RadioGroup r_p12 = (RadioGroup) findViewById(R.id.saneamento_p12);
        ...
        r_p12.setOnCheckedChangeListener(new RadioGroup.OnCheckedChangeListener() {
            ...
            public void onCheckedChanged(RadioGroup radioGroup, int i) {
                itemAvaliacao = ItemAvaliacaoController.limpaItemAvaliacao(itemAvaliacao);
                RadioButton na = (RadioButton) findViewById(R.id.saneamento_p12_na);
                RadioButton ad = (RadioButton) findViewById(R.id.saneamento_p12_ad);
                RadioButton in = (RadioButton) findViewById(R.id.saneamento_p12_in);

                ImageButton foto = (ImageButton) findViewById(R.id.saneamento_foto_p12);
                ImageButton descricao = (ImageButton) findViewById(R.id.saneamento_descricao_p12);


                TextView pergunta = (TextView) findViewById(R.id.saneamento_pergunta12);
                itemAvaliacao.setPergunta(pergunta.getText().toString());
                UserInterfaceController.radioButtonHandler(na, ad, in, foto, descricao, itemAvaliacao, context);
                ItemAvaliacaoController.salvarItemAvaliacao(itemAvaliacao, context);
            }
        ...
        RadioGroup r_p13 = (RadioGroup) findViewById(R.id.saneamento_p13);
        ...
        r_p13.setOnCheckedChangeListener(new RadioGroup.OnCheckedChangeListener() {
            ...
            public void onCheckedChanged(RadioGroup radioGroup, int i) {
                itemAvaliacao = ItemAvaliacaoController.limpaItemAvaliacao(itemAvaliacao);
                RadioButton na = (RadioButton) findViewById(R.id.saneamento_p13_na);
                RadioButton ad = (RadioButton) findViewById(R.id.saneamento_p13_ad);
                RadioButton in = (RadioButton) findViewById(R.id.saneamento_p13_in);

                ImageButton foto = (ImageButton) findViewById(R.id.saneamento_foto_p13);
                ImageButton descricao = (ImageButton) findViewById(R.id.saneamento_descricao_p13);


                TextView pergunta = (TextView) findViewById(R.id.saneamento_pergunta13);
                itemAvaliacao.setPergunta(pergunta.getText().toString());
                UserInterfaceController.radioButtonHandler(na, ad, in, foto, descricao, itemAvaliacao, context);
                ItemAvaliacaoController.salvarItemAvaliacao(itemAvaliacao, context);
            }
        ...
        RadioGroup r_p14 = (RadioGroup) findViewById(R.id.saneamento_p14);
        ...
        r_p14.setOnCheckedChangeListener(new RadioGroup.OnCheckedChangeListener() {
            ...
            public void onCheckedChanged(RadioGroup radioGroup, int i) {
                itemAvaliacao = ItemAvaliacaoController.limpaItemAvaliacao(itemAvaliacao);
                RadioButton na = (RadioButton) findViewById(R.id.saneamento_p14_na);
                RadioButton ad = (RadioButton) findViewById(R.id.saneamento_p14_ad);
                RadioButton in = (RadioButton) findViewById(R.id.saneamento_p14_in);

                ImageButton foto = (ImageButton) findViewById(R.id.saneamento_foto_p14);
                ImageButton descricao = (ImageButton) findViewById(R.id.saneamento_descricao_p14);


                TextView pergunta = (TextView) findViewById(R.id.saneamento_pergunta14);
                itemAvaliacao.setPergunta(pergunta.getText().toString());
                UserInterfaceController.radioButtonHandler(na, ad, in, foto, descricao, itemAvaliacao, context);
                ItemAvaliacaoController.salvarItemAvaliacao(itemAvaliacao, context);
            }
        ...
        RadioGroup r_p15 = (RadioGroup) findViewById(R.id.saneamento_p15);
        ...
        r_p15.setOnCheckedChangeListener(new RadioGroup.OnCheckedChangeListener() {
            ...
            public void onCheckedChanged(RadioGroup radioGroup, int i) {
                itemAvaliacao = ItemAvaliacaoController.limpaItemAvaliacao(itemAvaliacao);
                RadioButton na = (RadioButton) findViewById(R.id.saneamento_p15_na);
                RadioButton ad = (RadioButton) findViewById(R.id.saneamento_p15_ad);
                RadioButton in = (RadioButton) findViewById(R.id.saneamento_p15_in);

                ImageButton foto = (ImageButton) findViewById(R.id.saneamento_foto_p15);
                ImageButton descricao = (ImageButton) findViewById(R.id.saneamento_descricao_p15);


                TextView pergunta = (TextView) findViewById(R.id.saneamento_pergunta15);
                itemAvaliacao.setPergunta(pergunta.getText().toString());
                UserInterfaceController.radioButtonHandler(na, ad, in, foto, descricao, itemAvaliacao, context);
                ItemAvaliacaoController.salvarItemAvaliacao(itemAvaliacao, context);
            }
        ...
        RadioGroup r_p16 = (RadioGroup) findViewById(R.id.saneamento_p16);
        ...
        r_p16.setOnCheckedChangeListener(new RadioGroup.OnCheckedChangeListener() {
            ...
            public void onCheckedChanged(RadioGroup radioGroup, int i) {
                itemAvaliacao = ItemAvaliacaoController.limpaItemAvaliacao(itemAvaliacao);
                RadioButton na = (RadioButton) findViewById(R.id.saneamento_p16_na);
                RadioButton ad = (RadioButton) findViewById(R.id.saneamento_p16_ad);
                RadioButton in = (RadioButton) findViewById(R.id.saneamento_p16_in);

                ImageButton foto = (ImageButton) findViewById(R.id.saneamento_foto_p16);
                ImageButton descricao = (ImageButton) findViewById(R.id.saneamento_descricao_p16);


                TextView pergunta = (TextView) findViewById(R.id.saneamento_pergunta16);
                itemAvaliacao.setPergunta(pergunta.getText().toString());
                UserInterfaceController.radioButtonHandler(na, ad, in, foto, descricao, itemAvaliacao, context);
                ItemAvaliacaoController.salvarItemAvaliacao(itemAvaliacao, context);
            }
        ...
        RadioGroup r_p17 = (RadioGroup) findViewById(R.id.saneamento_p17);
        ...
        r_p17.setOnCheckedChangeListener(new RadioGroup.OnCheckedChangeListener() {
            ...
            public void onCheckedChanged(RadioGroup radioGroup, int i) {
                itemAvaliacao = ItemAvaliacaoController.limpaItemAvaliacao(itemAvaliacao);
                RadioButton na = (RadioButton) findViewById(R.id.saneamento_p17_na);
                RadioButton ad = (RadioButton) findViewById(R.id.saneamento_p17_ad);
                RadioButton in = (RadioButton) findViewById(R.id.saneamento_p17_in);

                ImageButton foto = (ImageButton) findViewById(R.id.saneamento_foto_p17);
                ImageButton descricao = (ImageButton) findViewById(R.id.saneamento_descricao_p17);


                TextView pergunta = (TextView) findViewById(R.id.saneamento_pergunta17);
                itemAvaliacao.setPergunta(pergunta.getText().toString());
                UserInterfaceController.radioButtonHandler(na, ad, in, foto, descricao, itemAvaliacao, context);
                ItemAvaliacaoController.salvarItemAvaliacao(itemAvaliacao, context);
            }
                        ...
                        public void onClick(DialogInterface dialog, int which) {
                            switch (which){
                                case DialogInterface.BUTTON_POSITIVE:
                                    Intent intentVaiProSaneamento = new Intent(context, Prt2619Activity.class);
    ...
    private void populateActivity(Context context) {
        ...
        listaRadioButtons.add((RadioButton) findViewById(R.id.saneamento_p9_na));
        listaRadioButtons.add((RadioButton) findViewById(R.id.saneamento_p9_ad));
        listaRadioButtons.add((RadioButton) findViewById(R.id.saneamento_p9_in));
        listaRadioButtons.add((RadioButton) findViewById(R.id.saneamento_p10_na));
        listaRadioButtons.add((RadioButton) findViewById(R.id.saneamento_p10_ad));
        listaRadioButtons.add((RadioButton) findViewById(R.id.saneamento_p10_in));
        listaRadioButtons.add((RadioButton) findViewById(R.id.saneamento_p11_na));
        listaRadioButtons.add((RadioButton) findViewById(R.id.saneamento_p11_ad));
        listaRadioButtons.add((RadioButton) findViewById(R.id.saneamento_p11_in));
        listaRadioButtons.add((RadioButton) findViewById(R.id.saneamento_p12_na));
        listaRadioButtons.add((RadioButton) findViewById(R.id.saneamento_p12_ad));
        listaRadioButtons.add((RadioButton) findViewById(R.id.saneamento_p12_in));
        listaRadioButtons.add((RadioButton) findViewById(R.id.saneamento_p13_na));
        listaRadioButtons.add((RadioButton) findViewById(R.id.saneamento_p13_ad));
        listaRadioButtons.add((RadioButton) findViewById(R.id.saneamento_p13_in));
        listaRadioButtons.add((RadioButton) findViewById(R.id.saneamento_p14_na));
        listaRadioButtons.add((RadioButton) findViewById(R.id.saneamento_p14_ad));
        listaRadioButtons.add((RadioButton) findViewById(R.id.saneamento_p14_in));
        listaRadioButtons.add((RadioButton) findViewById(R.id.saneamento_p15_na));
        listaRadioButtons.add((RadioButton) findViewById(R.id.saneamento_p15_ad));
        listaRadioButtons.add((RadioButton) findViewById(R.id.saneamento_p15_in));
        listaRadioButtons.add((RadioButton) findViewById(R.id.saneamento_p16_na));
        listaRadioButtons.add((RadioButton) findViewById(R.id.saneamento_p16_ad));
        listaRadioButtons.add((RadioButton) findViewById(R.id.saneamento_p16_in));
        listaRadioButtons.add((RadioButton) findViewById(R.id.saneamento_p17_na));
        listaRadioButtons.add((RadioButton) findViewById(R.id.saneamento_p17_ad));
        listaRadioButtons.add((RadioButton) findViewById(R.id.saneamento_p17_in));
        ...
        listaImageButtons.add((ImageButton) findViewById(R.id.saneamento_foto_p9));
        listaImageButtons.add((ImageButton) findViewById(R.id.saneamento_descricao_p9));
        listaImageButtons.add((ImageButton) findViewById(R.id.saneamento_foto_p10));
        listaImageButtons.add((ImageButton) findViewById(R.id.saneamento_descricao_p10));
        listaImageButtons.add((ImageButton) findViewById(R.id.saneamento_foto_p11));
        listaImageButtons.add((ImageButton) findViewById(R.id.saneamento_descricao_p11));
        listaImageButtons.add((ImageButton) findViewById(R.id.saneamento_foto_p12));
        listaImageButtons.add((ImageButton) findViewById(R.id.saneamento_descricao_p12));
        listaImageButtons.add((ImageButton) findViewById(R.id.saneamento_foto_p13));
        listaImageButtons.add((ImageButton) findViewById(R.id.saneamento_descricao_p13));
        listaImageButtons.add((ImageButton) findViewById(R.id.saneamento_foto_p14));
        listaImageButtons.add((ImageButton) findViewById(R.id.saneamento_descricao_p14));
        listaImageButtons.add((ImageButton) findViewById(R.id.saneamento_foto_p15));
        listaImageButtons.add((ImageButton) findViewById(R.id.saneamento_descricao_p15));
        listaImageButtons.add((ImageButton) findViewById(R.id.saneamento_foto_p16));
        listaImageButtons.add((ImageButton) findViewById(R.id.saneamento_descricao_p16));
        listaImageButtons.add((ImageButton) findViewById(R.id.saneamento_foto_p17));
        listaImageButtons.add((ImageButton) findViewById(R.id.saneamento_descricao_p17));
        ...
        listaTextViews.add((TextView) findViewById(R.id.saneamento_pergunta9));
        listaTextViews.add((TextView) findViewById(R.id.saneamento_pergunta10));
        listaTextViews.add((TextView) findViewById(R.id.saneamento_pergunta11));
        listaTextViews.add((TextView) findViewById(R.id.saneamento_pergunta12));
        listaTextViews.add((TextView) findViewById(R.id.saneamento_pergunta13));
        listaTextViews.add((TextView) findViewById(R.id.saneamento_pergunta14));
        listaTextViews.add((TextView) findViewById(R.id.saneamento_pergunta15));
        listaTextViews.add((TextView) findViewById(R.id.saneamento_pergunta16));
        listaTextViews.add((TextView) findViewById(R.id.saneamento_pergunta17));
