...
public class Prt2619_DocumentacaoActivity extends Activity {

    private ItemAvaliacao itemAvaliacao;
    private static final int NUMERO_PERGUNTAS = 48;

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_prt2619__documentacao);
        ...
        RadioGroup r_p25 = (RadioGroup) findViewById(R.id.documentacao_p25);
        ...
        r_p25.setOnCheckedChangeListener(new RadioGroup.OnCheckedChangeListener() {
            ...
            public void onCheckedChanged(RadioGroup radioGroup, int i) {
                itemAvaliacao = ItemAvaliacaoController.limpaItemAvaliacao(itemAvaliacao);
                RadioButton na = (RadioButton) findViewById(R.id.documentacao_p25_na);
                RadioButton ad = (RadioButton) findViewById(R.id.documentacao_p25_ad);
                RadioButton in = (RadioButton) findViewById(R.id.documentacao_p25_in);

                ImageButton foto = (ImageButton) findViewById(R.id.documentacao_foto_p25);
                ImageButton descricao = (ImageButton) findViewById(R.id.documentacao_descricao_p25);


                TextView pergunta = (TextView) findViewById(R.id.documentacao_pergunta25);
                itemAvaliacao.setPergunta(pergunta.getText().toString());
                UserInterfaceController.radioButtonHandler(na, ad, in, foto, descricao, itemAvaliacao, context);
                ItemAvaliacaoController.salvarItemAvaliacao(itemAvaliacao, context);
            }
        ...
        RadioGroup r_p26 = (RadioGroup) findViewById(R.id.documentacao_p26);
        ...
        r_p26.setOnCheckedChangeListener(new RadioGroup.OnCheckedChangeListener() {
            ...
            public void onCheckedChanged(RadioGroup radioGroup, int i) {
                itemAvaliacao = ItemAvaliacaoController.limpaItemAvaliacao(itemAvaliacao);
                RadioButton na = (RadioButton) findViewById(R.id.documentacao_p26_na);
                RadioButton ad = (RadioButton) findViewById(R.id.documentacao_p26_ad);
                RadioButton in = (RadioButton) findViewById(R.id.documentacao_p26_in);

                ImageButton foto = (ImageButton) findViewById(R.id.documentacao_foto_p26);
                ImageButton descricao = (ImageButton) findViewById(R.id.documentacao_descricao_p26);


                TextView pergunta = (TextView) findViewById(R.id.documentacao_pergunta26);
                itemAvaliacao.setPergunta(pergunta.getText().toString());
                UserInterfaceController.radioButtonHandler(na, ad, in, foto, descricao, itemAvaliacao, context);
                ItemAvaliacaoController.salvarItemAvaliacao(itemAvaliacao, context);
            }
        ...
        RadioGroup r_p27 = (RadioGroup) findViewById(R.id.documentacao_p27);
        ...
        r_p27.setOnCheckedChangeListener(new RadioGroup.OnCheckedChangeListener() {
            ...
            public void onCheckedChanged(RadioGroup radioGroup, int i) {
                itemAvaliacao = ItemAvaliacaoController.limpaItemAvaliacao(itemAvaliacao);
                RadioButton na = (RadioButton) findViewById(R.id.documentacao_p27_na);
                RadioButton ad = (RadioButton) findViewById(R.id.documentacao_p27_ad);
                RadioButton in = (RadioButton) findViewById(R.id.documentacao_p27_in);

                ImageButton foto = (ImageButton) findViewById(R.id.documentacao_foto_p27);
                ImageButton descricao = (ImageButton) findViewById(R.id.documentacao_descricao_p27);


                TextView pergunta = (TextView) findViewById(R.id.documentacao_pergunta27);
                itemAvaliacao.setPergunta(pergunta.getText().toString());
                UserInterfaceController.radioButtonHandler(na, ad, in, foto, descricao, itemAvaliacao, context);
                ItemAvaliacaoController.salvarItemAvaliacao(itemAvaliacao, context);
            }
        ...
        RadioGroup r_p28 = (RadioGroup) findViewById(R.id.documentacao_p28);
        ...
        r_p28.setOnCheckedChangeListener(new RadioGroup.OnCheckedChangeListener() {
            ...
            public void onCheckedChanged(RadioGroup radioGroup, int i) {
                itemAvaliacao = ItemAvaliacaoController.limpaItemAvaliacao(itemAvaliacao);
                RadioButton na = (RadioButton) findViewById(R.id.documentacao_p28_na);
                RadioButton ad = (RadioButton) findViewById(R.id.documentacao_p28_ad);
                RadioButton in = (RadioButton) findViewById(R.id.documentacao_p28_in);

                ImageButton foto = (ImageButton) findViewById(R.id.documentacao_foto_p28);
                ImageButton descricao = (ImageButton) findViewById(R.id.documentacao_descricao_p28);


                TextView pergunta = (TextView) findViewById(R.id.documentacao_pergunta28);
                itemAvaliacao.setPergunta(pergunta.getText().toString());
                UserInterfaceController.radioButtonHandler(na, ad, in, foto, descricao, itemAvaliacao, context);
                ItemAvaliacaoController.salvarItemAvaliacao(itemAvaliacao, context);
            }
        ...
        RadioGroup r_p29 = (RadioGroup) findViewById(R.id.documentacao_p29);
        ...
        r_p29.setOnCheckedChangeListener(new RadioGroup.OnCheckedChangeListener() {
            ...
            public void onCheckedChanged(RadioGroup radioGroup, int i) {
                itemAvaliacao = ItemAvaliacaoController.limpaItemAvaliacao(itemAvaliacao);
                RadioButton na = (RadioButton) findViewById(R.id.documentacao_p29_na);
                RadioButton ad = (RadioButton) findViewById(R.id.documentacao_p29_ad);
                RadioButton in = (RadioButton) findViewById(R.id.documentacao_p29_in);

                ImageButton foto = (ImageButton) findViewById(R.id.documentacao_foto_p29);
                ImageButton descricao = (ImageButton) findViewById(R.id.documentacao_descricao_p29);


                TextView pergunta = (TextView) findViewById(R.id.documentacao_pergunta29);
                itemAvaliacao.setPergunta(pergunta.getText().toString());
                UserInterfaceController.radioButtonHandler(na, ad, in, foto, descricao, itemAvaliacao, context);
                ItemAvaliacaoController.salvarItemAvaliacao(itemAvaliacao, context);
            }
        ...
        RadioGroup r_p30 = (RadioGroup) findViewById(R.id.documentacao_p30);
        ...
        r_p30.setOnCheckedChangeListener(new RadioGroup.OnCheckedChangeListener() {
            ...
            public void onCheckedChanged(RadioGroup radioGroup, int i) {
                itemAvaliacao = ItemAvaliacaoController.limpaItemAvaliacao(itemAvaliacao);
                RadioButton na = (RadioButton) findViewById(R.id.documentacao_p30_na);
                RadioButton ad = (RadioButton) findViewById(R.id.documentacao_p30_ad);
                RadioButton in = (RadioButton) findViewById(R.id.documentacao_p30_in);

                ImageButton foto = (ImageButton) findViewById(R.id.documentacao_foto_p30);
                ImageButton descricao = (ImageButton) findViewById(R.id.documentacao_descricao_p30);


                TextView pergunta = (TextView) findViewById(R.id.documentacao_pergunta30);
                itemAvaliacao.setPergunta(pergunta.getText().toString());
                UserInterfaceController.radioButtonHandler(na, ad, in, foto, descricao, itemAvaliacao, context);
                ItemAvaliacaoController.salvarItemAvaliacao(itemAvaliacao, context);
            }
        ...
        RadioGroup r_p31 = (RadioGroup) findViewById(R.id.documentacao_p31);
        ...
        r_p31.setOnCheckedChangeListener(new RadioGroup.OnCheckedChangeListener() {
            ...
            public void onCheckedChanged(RadioGroup radioGroup, int i) {
                itemAvaliacao = ItemAvaliacaoController.limpaItemAvaliacao(itemAvaliacao);
                RadioButton na = (RadioButton) findViewById(R.id.documentacao_p31_na);
                RadioButton ad = (RadioButton) findViewById(R.id.documentacao_p31_ad);
                RadioButton in = (RadioButton) findViewById(R.id.documentacao_p31_in);

                ImageButton foto = (ImageButton) findViewById(R.id.documentacao_foto_p31);
                ImageButton descricao = (ImageButton) findViewById(R.id.documentacao_descricao_p31);


                TextView pergunta = (TextView) findViewById(R.id.documentacao_pergunta31);
                itemAvaliacao.setPergunta(pergunta.getText().toString());
                UserInterfaceController.radioButtonHandler(na, ad, in, foto, descricao, itemAvaliacao, context);
                ItemAvaliacaoController.salvarItemAvaliacao(itemAvaliacao, context);
            }
        ...
        RadioGroup r_p32 = (RadioGroup) findViewById(R.id.documentacao_p32);
        ...
        r_p32.setOnCheckedChangeListener(new RadioGroup.OnCheckedChangeListener() {
            ...
            public void onCheckedChanged(RadioGroup radioGroup, int i) {
                itemAvaliacao = ItemAvaliacaoController.limpaItemAvaliacao(itemAvaliacao);
                RadioButton na = (RadioButton) findViewById(R.id.documentacao_p32_na);
                RadioButton ad = (RadioButton) findViewById(R.id.documentacao_p32_ad);
                RadioButton in = (RadioButton) findViewById(R.id.documentacao_p32_in);

                ImageButton foto = (ImageButton) findViewById(R.id.documentacao_foto_p32);
                ImageButton descricao = (ImageButton) findViewById(R.id.documentacao_descricao_p32);


                TextView pergunta = (TextView) findViewById(R.id.documentacao_pergunta32);
                itemAvaliacao.setPergunta(pergunta.getText().toString());
                UserInterfaceController.radioButtonHandler(na, ad, in, foto, descricao, itemAvaliacao, context);
                ItemAvaliacaoController.salvarItemAvaliacao(itemAvaliacao, context);
            }
        ...
        RadioGroup r_p33 = (RadioGroup) findViewById(R.id.documentacao_p33);
        ...
        r_p33.setOnCheckedChangeListener(new RadioGroup.OnCheckedChangeListener() {
            ...
            public void onCheckedChanged(RadioGroup radioGroup, int i) {
                itemAvaliacao = ItemAvaliacaoController.limpaItemAvaliacao(itemAvaliacao);
                RadioButton na = (RadioButton) findViewById(R.id.documentacao_p33_na);
                RadioButton ad = (RadioButton) findViewById(R.id.documentacao_p33_ad);
                RadioButton in = (RadioButton) findViewById(R.id.documentacao_p33_in);

                ImageButton foto = (ImageButton) findViewById(R.id.documentacao_foto_p33);
                ImageButton descricao = (ImageButton) findViewById(R.id.documentacao_descricao_p33);


                TextView pergunta = (TextView) findViewById(R.id.documentacao_pergunta33);
                itemAvaliacao.setPergunta(pergunta.getText().toString());
                UserInterfaceController.radioButtonHandler(na, ad, in, foto, descricao, itemAvaliacao, context);
                ItemAvaliacaoController.salvarItemAvaliacao(itemAvaliacao, context);
            }
        ...
        RadioGroup r_p34 = (RadioGroup) findViewById(R.id.documentacao_p34);
        ...
        r_p34.setOnCheckedChangeListener(new RadioGroup.OnCheckedChangeListener() {
            ...
            public void onCheckedChanged(RadioGroup radioGroup, int i) {
                itemAvaliacao = ItemAvaliacaoController.limpaItemAvaliacao(itemAvaliacao);
                RadioButton na = (RadioButton) findViewById(R.id.documentacao_p34_na);
                RadioButton ad = (RadioButton) findViewById(R.id.documentacao_p34_ad);
                RadioButton in = (RadioButton) findViewById(R.id.documentacao_p34_in);

                ImageButton foto = (ImageButton) findViewById(R.id.documentacao_foto_p34);
                ImageButton descricao = (ImageButton) findViewById(R.id.documentacao_descricao_p34);


                TextView pergunta = (TextView) findViewById(R.id.documentacao_pergunta34);
                itemAvaliacao.setPergunta(pergunta.getText().toString());
                UserInterfaceController.radioButtonHandler(na, ad, in, foto, descricao, itemAvaliacao, context);
                ItemAvaliacaoController.salvarItemAvaliacao(itemAvaliacao, context);
            }
        ...
        RadioGroup r_p35 = (RadioGroup) findViewById(R.id.documentacao_p35);
        ...
        r_p35.setOnCheckedChangeListener(new RadioGroup.OnCheckedChangeListener() {
            ...
            public void onCheckedChanged(RadioGroup radioGroup, int i) {
                itemAvaliacao = ItemAvaliacaoController.limpaItemAvaliacao(itemAvaliacao);
                RadioButton na = (RadioButton) findViewById(R.id.documentacao_p35_na);
                RadioButton ad = (RadioButton) findViewById(R.id.documentacao_p35_ad);
                RadioButton in = (RadioButton) findViewById(R.id.documentacao_p35_in);

                ImageButton foto = (ImageButton) findViewById(R.id.documentacao_foto_p35);
                ImageButton descricao = (ImageButton) findViewById(R.id.documentacao_descricao_p35);


                TextView pergunta = (TextView) findViewById(R.id.documentacao_pergunta35);
                itemAvaliacao.setPergunta(pergunta.getText().toString());
                UserInterfaceController.radioButtonHandler(na, ad, in, foto, descricao, itemAvaliacao, context);
                ItemAvaliacaoController.salvarItemAvaliacao(itemAvaliacao, context);
            }
        ...
        RadioGroup r_p36 = (RadioGroup) findViewById(R.id.documentacao_p36);
        ...
        r_p36.setOnCheckedChangeListener(new RadioGroup.OnCheckedChangeListener() {
            ...
            public void onCheckedChanged(RadioGroup radioGroup, int i) {
                itemAvaliacao = ItemAvaliacaoController.limpaItemAvaliacao(itemAvaliacao);
                RadioButton na = (RadioButton) findViewById(R.id.documentacao_p36_na);
                RadioButton ad = (RadioButton) findViewById(R.id.documentacao_p36_ad);
                RadioButton in = (RadioButton) findViewById(R.id.documentacao_p36_in);

                ImageButton foto = (ImageButton) findViewById(R.id.documentacao_foto_p36);
                ImageButton descricao = (ImageButton) findViewById(R.id.documentacao_descricao_p36);


                TextView pergunta = (TextView) findViewById(R.id.documentacao_pergunta36);
                itemAvaliacao.setPergunta(pergunta.getText().toString());
                UserInterfaceController.radioButtonHandler(na, ad, in, foto, descricao, itemAvaliacao, context);
                ItemAvaliacaoController.salvarItemAvaliacao(itemAvaliacao, context);
            }
        ...
        RadioGroup r_p37 = (RadioGroup) findViewById(R.id.documentacao_p37);
        ...
        r_p37.setOnCheckedChangeListener(new RadioGroup.OnCheckedChangeListener() {
            ...
            public void onCheckedChanged(RadioGroup radioGroup, int i) {
                itemAvaliacao = ItemAvaliacaoController.limpaItemAvaliacao(itemAvaliacao);
                RadioButton na = (RadioButton) findViewById(R.id.documentacao_p37_na);
                RadioButton ad = (RadioButton) findViewById(R.id.documentacao_p37_ad);
                RadioButton in = (RadioButton) findViewById(R.id.documentacao_p37_in);

                ImageButton foto = (ImageButton) findViewById(R.id.documentacao_foto_p37);
                ImageButton descricao = (ImageButton) findViewById(R.id.documentacao_descricao_p37);


                TextView pergunta = (TextView) findViewById(R.id.documentacao_pergunta37);
                itemAvaliacao.setPergunta(pergunta.getText().toString());
                UserInterfaceController.radioButtonHandler(na, ad, in, foto, descricao, itemAvaliacao, context);
                ItemAvaliacaoController.salvarItemAvaliacao(itemAvaliacao, context);
            }
        ...
        RadioGroup r_p38 = (RadioGroup) findViewById(R.id.documentacao_p38);
        ...
        r_p38.setOnCheckedChangeListener(new RadioGroup.OnCheckedChangeListener() {
            ...
            public void onCheckedChanged(RadioGroup radioGroup, int i) {
                itemAvaliacao = ItemAvaliacaoController.limpaItemAvaliacao(itemAvaliacao);
                RadioButton na = (RadioButton) findViewById(R.id.documentacao_p38_na);
                RadioButton ad = (RadioButton) findViewById(R.id.documentacao_p38_ad);
                RadioButton in = (RadioButton) findViewById(R.id.documentacao_p38_in);

                ImageButton foto = (ImageButton) findViewById(R.id.documentacao_foto_p38);
                ImageButton descricao = (ImageButton) findViewById(R.id.documentacao_descricao_p38);


                TextView pergunta = (TextView) findViewById(R.id.documentacao_pergunta38);
                itemAvaliacao.setPergunta(pergunta.getText().toString());
                UserInterfaceController.radioButtonHandler(na, ad, in, foto, descricao, itemAvaliacao, context);
                ItemAvaliacaoController.salvarItemAvaliacao(itemAvaliacao, context);
            }
        ...
        RadioGroup r_p39 = (RadioGroup) findViewById(R.id.documentacao_p39);
        ...
        r_p39.setOnCheckedChangeListener(new RadioGroup.OnCheckedChangeListener() {
            ...
            public void onCheckedChanged(RadioGroup radioGroup, int i) {
                itemAvaliacao = ItemAvaliacaoController.limpaItemAvaliacao(itemAvaliacao);
                RadioButton na = (RadioButton) findViewById(R.id.documentacao_p39_na);
                RadioButton ad = (RadioButton) findViewById(R.id.documentacao_p39_ad);
                RadioButton in = (RadioButton) findViewById(R.id.documentacao_p39_in);

                ImageButton foto = (ImageButton) findViewById(R.id.documentacao_foto_p39);
                ImageButton descricao = (ImageButton) findViewById(R.id.documentacao_descricao_p39);


                TextView pergunta = (TextView) findViewById(R.id.documentacao_pergunta39);
                itemAvaliacao.setPergunta(pergunta.getText().toString());
                UserInterfaceController.radioButtonHandler(na, ad, in, foto, descricao, itemAvaliacao, context);
                ItemAvaliacaoController.salvarItemAvaliacao(itemAvaliacao, context);
            }
        ...
        RadioGroup r_p40 = (RadioGroup) findViewById(R.id.documentacao_p40);
        ...
        r_p40.setOnCheckedChangeListener(new RadioGroup.OnCheckedChangeListener() {
            ...
            public void onCheckedChanged(RadioGroup radioGroup, int i) {
                itemAvaliacao = ItemAvaliacaoController.limpaItemAvaliacao(itemAvaliacao);
                RadioButton na = (RadioButton) findViewById(R.id.documentacao_p40_na);
                RadioButton ad = (RadioButton) findViewById(R.id.documentacao_p40_ad);
                RadioButton in = (RadioButton) findViewById(R.id.documentacao_p40_in);

                ImageButton foto = (ImageButton) findViewById(R.id.documentacao_foto_p40);
                ImageButton descricao = (ImageButton) findViewById(R.id.documentacao_descricao_p40);


                TextView pergunta = (TextView) findViewById(R.id.documentacao_pergunta40);
                itemAvaliacao.setPergunta(pergunta.getText().toString());
                UserInterfaceController.radioButtonHandler(na, ad, in, foto, descricao, itemAvaliacao, context);
                ItemAvaliacaoController.salvarItemAvaliacao(itemAvaliacao, context);
            }
        ...
        RadioGroup r_p41 = (RadioGroup) findViewById(R.id.documentacao_p41);
        ...
        r_p41.setOnCheckedChangeListener(new RadioGroup.OnCheckedChangeListener() {
            ...
            public void onCheckedChanged(RadioGroup radioGroup, int i) {
                itemAvaliacao = ItemAvaliacaoController.limpaItemAvaliacao(itemAvaliacao);
                RadioButton na = (RadioButton) findViewById(R.id.documentacao_p41_na);
                RadioButton ad = (RadioButton) findViewById(R.id.documentacao_p41_ad);
                RadioButton in = (RadioButton) findViewById(R.id.documentacao_p41_in);

                ImageButton foto = (ImageButton) findViewById(R.id.documentacao_foto_p41);
                ImageButton descricao = (ImageButton) findViewById(R.id.documentacao_descricao_p41);


                TextView pergunta = (TextView) findViewById(R.id.documentacao_pergunta41);
                itemAvaliacao.setPergunta(pergunta.getText().toString());
                UserInterfaceController.radioButtonHandler(na, ad, in, foto, descricao, itemAvaliacao, context);
                ItemAvaliacaoController.salvarItemAvaliacao(itemAvaliacao, context);
            }
        ...
        RadioGroup r_p42 = (RadioGroup) findViewById(R.id.documentacao_p42);
        ...
        r_p42.setOnCheckedChangeListener(new RadioGroup.OnCheckedChangeListener() {
            ...
            public void onCheckedChanged(RadioGroup radioGroup, int i) {
                itemAvaliacao = ItemAvaliacaoController.limpaItemAvaliacao(itemAvaliacao);
                RadioButton na = (RadioButton) findViewById(R.id.documentacao_p42_na);
                RadioButton ad = (RadioButton) findViewById(R.id.documentacao_p42_ad);
                RadioButton in = (RadioButton) findViewById(R.id.documentacao_p42_in);

                ImageButton foto = (ImageButton) findViewById(R.id.documentacao_foto_p42);
                ImageButton descricao = (ImageButton) findViewById(R.id.documentacao_descricao_p42);


                TextView pergunta = (TextView) findViewById(R.id.documentacao_pergunta42);
                itemAvaliacao.setPergunta(pergunta.getText().toString());
                UserInterfaceController.radioButtonHandler(na, ad, in, foto, descricao, itemAvaliacao, context);
                ItemAvaliacaoController.salvarItemAvaliacao(itemAvaliacao, context);
            }
        ...
        RadioGroup r_p43 = (RadioGroup) findViewById(R.id.documentacao_p43);
        ...
        r_p43.setOnCheckedChangeListener(new RadioGroup.OnCheckedChangeListener() {
            ...
            public void onCheckedChanged(RadioGroup radioGroup, int i) {
                itemAvaliacao = ItemAvaliacaoController.limpaItemAvaliacao(itemAvaliacao);
                RadioButton na = (RadioButton) findViewById(R.id.documentacao_p43_na);
                RadioButton ad = (RadioButton) findViewById(R.id.documentacao_p43_ad);
                RadioButton in = (RadioButton) findViewById(R.id.documentacao_p43_in);

                ImageButton foto = (ImageButton) findViewById(R.id.documentacao_foto_p43);
                ImageButton descricao = (ImageButton) findViewById(R.id.documentacao_descricao_p43);


                TextView pergunta = (TextView) findViewById(R.id.documentacao_pergunta43);
                itemAvaliacao.setPergunta(pergunta.getText().toString());
                UserInterfaceController.radioButtonHandler(na, ad, in, foto, descricao, itemAvaliacao, context);
                ItemAvaliacaoController.salvarItemAvaliacao(itemAvaliacao, context);
            }
        ...
        RadioGroup r_p44 = (RadioGroup) findViewById(R.id.documentacao_p44);
        ...
        r_p44.setOnCheckedChangeListener(new RadioGroup.OnCheckedChangeListener() {
            ...
            public void onCheckedChanged(RadioGroup radioGroup, int i) {
                itemAvaliacao = ItemAvaliacaoController.limpaItemAvaliacao(itemAvaliacao);
                RadioButton na = (RadioButton) findViewById(R.id.documentacao_p44_na);
                RadioButton ad = (RadioButton) findViewById(R.id.documentacao_p44_ad);
                RadioButton in = (RadioButton) findViewById(R.id.documentacao_p44_in);

                ImageButton foto = (ImageButton) findViewById(R.id.documentacao_foto_p44);
                ImageButton descricao = (ImageButton) findViewById(R.id.documentacao_descricao_p44);


                TextView pergunta = (TextView) findViewById(R.id.documentacao_pergunta44);
                itemAvaliacao.setPergunta(pergunta.getText().toString());
                UserInterfaceController.radioButtonHandler(na, ad, in, foto, descricao, itemAvaliacao, context);
                ItemAvaliacaoController.salvarItemAvaliacao(itemAvaliacao, context);
            }
        ...
        RadioGroup r_p45 = (RadioGroup) findViewById(R.id.documentacao_p45);
        ...
        r_p45.setOnCheckedChangeListener(new RadioGroup.OnCheckedChangeListener() {
            ...
            public void onCheckedChanged(RadioGroup radioGroup, int i) {
                itemAvaliacao = ItemAvaliacaoController.limpaItemAvaliacao(itemAvaliacao);
                RadioButton na = (RadioButton) findViewById(R.id.documentacao_p45_na);
                RadioButton ad = (RadioButton) findViewById(R.id.documentacao_p45_ad);
                RadioButton in = (RadioButton) findViewById(R.id.documentacao_p45_in);

                ImageButton foto = (ImageButton) findViewById(R.id.documentacao_foto_p45);
                ImageButton descricao = (ImageButton) findViewById(R.id.documentacao_descricao_p45);


                TextView pergunta = (TextView) findViewById(R.id.documentacao_pergunta45);
                itemAvaliacao.setPergunta(pergunta.getText().toString());
                UserInterfaceController.radioButtonHandler(na, ad, in, foto, descricao, itemAvaliacao, context);
                ItemAvaliacaoController.salvarItemAvaliacao(itemAvaliacao, context);
            }
        ...
        RadioGroup r_p46 = (RadioGroup) findViewById(R.id.documentacao_p46);
        ...
        r_p46.setOnCheckedChangeListener(new RadioGroup.OnCheckedChangeListener() {
            ...
            public void onCheckedChanged(RadioGroup radioGroup, int i) {
                itemAvaliacao = ItemAvaliacaoController.limpaItemAvaliacao(itemAvaliacao);
                RadioButton na = (RadioButton) findViewById(R.id.documentacao_p46_na);
                RadioButton ad = (RadioButton) findViewById(R.id.documentacao_p46_ad);
                RadioButton in = (RadioButton) findViewById(R.id.documentacao_p46_in);

                ImageButton foto = (ImageButton) findViewById(R.id.documentacao_foto_p46);
                ImageButton descricao = (ImageButton) findViewById(R.id.documentacao_descricao_p46);


                TextView pergunta = (TextView) findViewById(R.id.documentacao_pergunta46);
                itemAvaliacao.setPergunta(pergunta.getText().toString());
                UserInterfaceController.radioButtonHandler(na, ad, in, foto, descricao, itemAvaliacao, context);
                ItemAvaliacaoController.salvarItemAvaliacao(itemAvaliacao, context);
            }
        ...
        RadioGroup r_p47 = (RadioGroup) findViewById(R.id.documentacao_p47);
        ...
        r_p47.setOnCheckedChangeListener(new RadioGroup.OnCheckedChangeListener() {
            ...
            public void onCheckedChanged(RadioGroup radioGroup, int i) {
                itemAvaliacao = ItemAvaliacaoController.limpaItemAvaliacao(itemAvaliacao);
                RadioButton na = (RadioButton) findViewById(R.id.documentacao_p47_na);
                RadioButton ad = (RadioButton) findViewById(R.id.documentacao_p47_ad);
                RadioButton in = (RadioButton) findViewById(R.id.documentacao_p47_in);

                ImageButton foto = (ImageButton) findViewById(R.id.documentacao_foto_p47);
                ImageButton descricao = (ImageButton) findViewById(R.id.documentacao_descricao_p47);


                TextView pergunta = (TextView) findViewById(R.id.documentacao_pergunta47);
                itemAvaliacao.setPergunta(pergunta.getText().toString());
                UserInterfaceController.radioButtonHandler(na, ad, in, foto, descricao, itemAvaliacao, context);
                ItemAvaliacaoController.salvarItemAvaliacao(itemAvaliacao, context);
            }
        ...
        RadioGroup r_p48 = (RadioGroup) findViewById(R.id.documentacao_p48);
        ...
        r_p48.setOnCheckedChangeListener(new RadioGroup.OnCheckedChangeListener() {
            ...
            public void onCheckedChanged(RadioGroup radioGroup, int i) {
                itemAvaliacao = ItemAvaliacaoController.limpaItemAvaliacao(itemAvaliacao);
                RadioButton na = (RadioButton) findViewById(R.id.documentacao_p48_na);
                RadioButton ad = (RadioButton) findViewById(R.id.documentacao_p48_ad);
                RadioButton in = (RadioButton) findViewById(R.id.documentacao_p48_in);

                ImageButton foto = (ImageButton) findViewById(R.id.documentacao_foto_p48);
                ImageButton descricao = (ImageButton) findViewById(R.id.documentacao_descricao_p48);


                TextView pergunta = (TextView) findViewById(R.id.documentacao_pergunta48);
                itemAvaliacao.setPergunta(pergunta.getText().toString());
                UserInterfaceController.radioButtonHandler(na, ad, in, foto, descricao, itemAvaliacao, context);
                ItemAvaliacaoController.salvarItemAvaliacao(itemAvaliacao, context);
            }
                        ...
                        public void onClick(DialogInterface dialog, int which) {
                            switch (which){
                                case DialogInterface.BUTTON_POSITIVE:
                                    Intent intentVaiProDocumentacao = new Intent(context, Prt2619Activity.class);
    ...
    private void populateActivity(Context context) {
        ...
        listaRadioButtons.add((RadioButton) findViewById(R.id.documentacao_p25_na));
        listaRadioButtons.add((RadioButton) findViewById(R.id.documentacao_p25_ad));
        listaRadioButtons.add((RadioButton) findViewById(R.id.documentacao_p25_in));
        listaRadioButtons.add((RadioButton) findViewById(R.id.documentacao_p26_na));
        listaRadioButtons.add((RadioButton) findViewById(R.id.documentacao_p26_ad));
        listaRadioButtons.add((RadioButton) findViewById(R.id.documentacao_p26_in));
        listaRadioButtons.add((RadioButton) findViewById(R.id.documentacao_p27_na));
        listaRadioButtons.add((RadioButton) findViewById(R.id.documentacao_p27_ad));
        listaRadioButtons.add((RadioButton) findViewById(R.id.documentacao_p27_in));
        listaRadioButtons.add((RadioButton) findViewById(R.id.documentacao_p28_na));
        listaRadioButtons.add((RadioButton) findViewById(R.id.documentacao_p28_ad));
        listaRadioButtons.add((RadioButton) findViewById(R.id.documentacao_p28_in));
        listaRadioButtons.add((RadioButton) findViewById(R.id.documentacao_p29_na));
        listaRadioButtons.add((RadioButton) findViewById(R.id.documentacao_p29_ad));
        listaRadioButtons.add((RadioButton) findViewById(R.id.documentacao_p29_in));
        listaRadioButtons.add((RadioButton) findViewById(R.id.documentacao_p30_na));
        listaRadioButtons.add((RadioButton) findViewById(R.id.documentacao_p30_ad));
        listaRadioButtons.add((RadioButton) findViewById(R.id.documentacao_p30_in));
        listaRadioButtons.add((RadioButton) findViewById(R.id.documentacao_p31_na));
        listaRadioButtons.add((RadioButton) findViewById(R.id.documentacao_p31_ad));
        listaRadioButtons.add((RadioButton) findViewById(R.id.documentacao_p31_in));
        listaRadioButtons.add((RadioButton) findViewById(R.id.documentacao_p32_na));
        listaRadioButtons.add((RadioButton) findViewById(R.id.documentacao_p32_ad));
        listaRadioButtons.add((RadioButton) findViewById(R.id.documentacao_p32_in));
        listaRadioButtons.add((RadioButton) findViewById(R.id.documentacao_p33_na));
        listaRadioButtons.add((RadioButton) findViewById(R.id.documentacao_p33_ad));
        listaRadioButtons.add((RadioButton) findViewById(R.id.documentacao_p33_in));
        listaRadioButtons.add((RadioButton) findViewById(R.id.documentacao_p34_na));
        listaRadioButtons.add((RadioButton) findViewById(R.id.documentacao_p34_ad));
        listaRadioButtons.add((RadioButton) findViewById(R.id.documentacao_p34_in));
        listaRadioButtons.add((RadioButton) findViewById(R.id.documentacao_p35_na));
        listaRadioButtons.add((RadioButton) findViewById(R.id.documentacao_p35_ad));
        listaRadioButtons.add((RadioButton) findViewById(R.id.documentacao_p35_in));
        listaRadioButtons.add((RadioButton) findViewById(R.id.documentacao_p36_na));
        listaRadioButtons.add((RadioButton) findViewById(R.id.documentacao_p36_ad));
        listaRadioButtons.add((RadioButton) findViewById(R.id.documentacao_p36_in));
        listaRadioButtons.add((RadioButton) findViewById(R.id.documentacao_p37_na));
        listaRadioButtons.add((RadioButton) findViewById(R.id.documentacao_p37_ad));
        listaRadioButtons.add((RadioButton) findViewById(R.id.documentacao_p37_in));
        listaRadioButtons.add((RadioButton) findViewById(R.id.documentacao_p38_na));
        listaRadioButtons.add((RadioButton) findViewById(R.id.documentacao_p38_ad));
        listaRadioButtons.add((RadioButton) findViewById(R.id.documentacao_p38_in));
        listaRadioButtons.add((RadioButton) findViewById(R.id.documentacao_p39_na));
        listaRadioButtons.add((RadioButton) findViewById(R.id.documentacao_p39_ad));
        listaRadioButtons.add((RadioButton) findViewById(R.id.documentacao_p39_in));
        listaRadioButtons.add((RadioButton) findViewById(R.id.documentacao_p40_na));
        listaRadioButtons.add((RadioButton) findViewById(R.id.documentacao_p40_ad));
        listaRadioButtons.add((RadioButton) findViewById(R.id.documentacao_p40_in));
        listaRadioButtons.add((RadioButton) findViewById(R.id.documentacao_p41_na));
        listaRadioButtons.add((RadioButton) findViewById(R.id.documentacao_p41_ad));
        listaRadioButtons.add((RadioButton) findViewById(R.id.documentacao_p41_in));
        listaRadioButtons.add((RadioButton) findViewById(R.id.documentacao_p42_na));
        listaRadioButtons.add((RadioButton) findViewById(R.id.documentacao_p42_ad));
        listaRadioButtons.add((RadioButton) findViewById(R.id.documentacao_p42_in));
        listaRadioButtons.add((RadioButton) findViewById(R.id.documentacao_p43_na));
        listaRadioButtons.add((RadioButton) findViewById(R.id.documentacao_p43_ad));
        listaRadioButtons.add((RadioButton) findViewById(R.id.documentacao_p43_in));
        listaRadioButtons.add((RadioButton) findViewById(R.id.documentacao_p44_na));
        listaRadioButtons.add((RadioButton) findViewById(R.id.documentacao_p44_ad));
        listaRadioButtons.add((RadioButton) findViewById(R.id.documentacao_p44_in));
        listaRadioButtons.add((RadioButton) findViewById(R.id.documentacao_p45_na));
        listaRadioButtons.add((RadioButton) findViewById(R.id.documentacao_p45_ad));
        listaRadioButtons.add((RadioButton) findViewById(R.id.documentacao_p45_in));
        listaRadioButtons.add((RadioButton) findViewById(R.id.documentacao_p46_na));
        listaRadioButtons.add((RadioButton) findViewById(R.id.documentacao_p46_ad));
        listaRadioButtons.add((RadioButton) findViewById(R.id.documentacao_p46_in));
        listaRadioButtons.add((RadioButton) findViewById(R.id.documentacao_p47_na));
        listaRadioButtons.add((RadioButton) findViewById(R.id.documentacao_p47_ad));
        listaRadioButtons.add((RadioButton) findViewById(R.id.documentacao_p47_in));
        listaRadioButtons.add((RadioButton) findViewById(R.id.documentacao_p48_na));
        listaRadioButtons.add((RadioButton) findViewById(R.id.documentacao_p48_ad));
        listaRadioButtons.add((RadioButton) findViewById(R.id.documentacao_p48_in));
        ...
        listaImageButtons.add((ImageButton) findViewById(R.id.documentacao_foto_p25));
        listaImageButtons.add((ImageButton) findViewById(R.id.documentacao_descricao_p25));
        listaImageButtons.add((ImageButton) findViewById(R.id.documentacao_foto_p26));
        listaImageButtons.add((ImageButton) findViewById(R.id.documentacao_descricao_p26));
        listaImageButtons.add((ImageButton) findViewById(R.id.documentacao_foto_p27));
        listaImageButtons.add((ImageButton) findViewById(R.id.documentacao_descricao_p27));
        listaImageButtons.add((ImageButton) findViewById(R.id.documentacao_foto_p28));
        listaImageButtons.add((ImageButton) findViewById(R.id.documentacao_descricao_p28));
        listaImageButtons.add((ImageButton) findViewById(R.id.documentacao_foto_p29));
        listaImageButtons.add((ImageButton) findViewById(R.id.documentacao_descricao_p29));
        listaImageButtons.add((ImageButton) findViewById(R.id.documentacao_foto_p30));
        listaImageButtons.add((ImageButton) findViewById(R.id.documentacao_descricao_p30));
        listaImageButtons.add((ImageButton) findViewById(R.id.documentacao_foto_p31));
        listaImageButtons.add((ImageButton) findViewById(R.id.documentacao_descricao_p31));
        listaImageButtons.add((ImageButton) findViewById(R.id.documentacao_foto_p32));
        listaImageButtons.add((ImageButton) findViewById(R.id.documentacao_descricao_p32));
        listaImageButtons.add((ImageButton) findViewById(R.id.documentacao_foto_p33));
        listaImageButtons.add((ImageButton) findViewById(R.id.documentacao_descricao_p33));
        listaImageButtons.add((ImageButton) findViewById(R.id.documentacao_foto_p34));
        listaImageButtons.add((ImageButton) findViewById(R.id.documentacao_descricao_p34));
        listaImageButtons.add((ImageButton) findViewById(R.id.documentacao_foto_p35));
        listaImageButtons.add((ImageButton) findViewById(R.id.documentacao_descricao_p35));
        listaImageButtons.add((ImageButton) findViewById(R.id.documentacao_foto_p36));
        listaImageButtons.add((ImageButton) findViewById(R.id.documentacao_descricao_p36));
        listaImageButtons.add((ImageButton) findViewById(R.id.documentacao_foto_p37));
        listaImageButtons.add((ImageButton) findViewById(R.id.documentacao_descricao_p37));
        listaImageButtons.add((ImageButton) findViewById(R.id.documentacao_foto_p38));
        listaImageButtons.add((ImageButton) findViewById(R.id.documentacao_descricao_p38));
        listaImageButtons.add((ImageButton) findViewById(R.id.documentacao_foto_p39));
        listaImageButtons.add((ImageButton) findViewById(R.id.documentacao_descricao_p39));
        listaImageButtons.add((ImageButton) findViewById(R.id.documentacao_foto_p40));
        listaImageButtons.add((ImageButton) findViewById(R.id.documentacao_descricao_p40));
        listaImageButtons.add((ImageButton) findViewById(R.id.documentacao_foto_p41));
        listaImageButtons.add((ImageButton) findViewById(R.id.documentacao_descricao_p41));
        listaImageButtons.add((ImageButton) findViewById(R.id.documentacao_foto_p42));
        listaImageButtons.add((ImageButton) findViewById(R.id.documentacao_descricao_p42));
        listaImageButtons.add((ImageButton) findViewById(R.id.documentacao_foto_p43));
        listaImageButtons.add((ImageButton) findViewById(R.id.documentacao_descricao_p43));
        listaImageButtons.add((ImageButton) findViewById(R.id.documentacao_foto_p44));
        listaImageButtons.add((ImageButton) findViewById(R.id.documentacao_descricao_p44));
        listaImageButtons.add((ImageButton) findViewById(R.id.documentacao_foto_p45));
        listaImageButtons.add((ImageButton) findViewById(R.id.documentacao_descricao_p45));
        listaImageButtons.add((ImageButton) findViewById(R.id.documentacao_foto_p46));
        listaImageButtons.add((ImageButton) findViewById(R.id.documentacao_descricao_p46));
        listaImageButtons.add((ImageButton) findViewById(R.id.documentacao_foto_p47));
        listaImageButtons.add((ImageButton) findViewById(R.id.documentacao_descricao_p47));
        listaImageButtons.add((ImageButton) findViewById(R.id.documentacao_foto_p48));
        listaImageButtons.add((ImageButton) findViewById(R.id.documentacao_descricao_p48));
        ...
        listaTextViews.add((TextView) findViewById(R.id.documentacao_pergunta25));
        listaTextViews.add((TextView) findViewById(R.id.documentacao_pergunta26));
        listaTextViews.add((TextView) findViewById(R.id.documentacao_pergunta27));
        listaTextViews.add((TextView) findViewById(R.id.documentacao_pergunta28));
        listaTextViews.add((TextView) findViewById(R.id.documentacao_pergunta29));
        listaTextViews.add((TextView) findViewById(R.id.documentacao_pergunta30));
        listaTextViews.add((TextView) findViewById(R.id.documentacao_pergunta31));
        listaTextViews.add((TextView) findViewById(R.id.documentacao_pergunta32));
        listaTextViews.add((TextView) findViewById(R.id.documentacao_pergunta33));
        listaTextViews.add((TextView) findViewById(R.id.documentacao_pergunta34));
        listaTextViews.add((TextView) findViewById(R.id.documentacao_pergunta35));
        listaTextViews.add((TextView) findViewById(R.id.documentacao_pergunta36));
        listaTextViews.add((TextView) findViewById(R.id.documentacao_pergunta37));
        listaTextViews.add((TextView) findViewById(R.id.documentacao_pergunta38));
        listaTextViews.add((TextView) findViewById(R.id.documentacao_pergunta39));
        listaTextViews.add((TextView) findViewById(R.id.documentacao_pergunta40));
        listaTextViews.add((TextView) findViewById(R.id.documentacao_pergunta41));
        listaTextViews.add((TextView) findViewById(R.id.documentacao_pergunta42));
        listaTextViews.add((TextView) findViewById(R.id.documentacao_pergunta43));
        listaTextViews.add((TextView) findViewById(R.id.documentacao_pergunta44));
        listaTextViews.add((TextView) findViewById(R.id.documentacao_pergunta45));
        listaTextViews.add((TextView) findViewById(R.id.documentacao_pergunta46));
        listaTextViews.add((TextView) findViewById(R.id.documentacao_pergunta47));
        listaTextViews.add((TextView) findViewById(R.id.documentacao_pergunta48));
