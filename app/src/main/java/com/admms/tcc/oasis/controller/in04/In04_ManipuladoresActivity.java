...
public class In04_ManipuladoresActivity extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        r_p1.setOnCheckedChangeListener(new RadioGroup.OnCheckedChangeListener() {
            ...
            public void onCheckedChanged(RadioGroup radioGroup, int i) {
                ...
                ItemAvaliacaoController.salvarItemAvaliacao(itemAvaliacao, In04_ManipuladoresActivity.this);
            }
        });
        ...
        manipuladoresSalvar.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                List<ItemAvaliacao> listaItens = ItemAvaliacaoController.buscaItemAvaliacaoPorAreaAvaliada(planoAcao,Constantes.AREA_AVALIADA_MANIPULADORES, In04_ManipuladoresActivity.this);
                ...
                if (NUMERO_PERGUNTAS != listaItens.size()) {
                    ...
                    AlertDialog.Builder builder = new AlertDialog.Builder(In04_ManipuladoresActivity.this);
    ...
    protected void mostraJanelaDescricao(final ItemAvaliacao itemAvaliacao) {
        ...
        LayoutInflater layoutInflater = LayoutInflater.from(In04_ManipuladoresActivity.this);
        View promptView = layoutInflater.inflate(R.layout.activity_pop_up, null);
        AlertDialog.Builder alertDialogBuilder = new AlertDialog.Builder(In04_ManipuladoresActivity.this);
