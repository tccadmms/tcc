...
public class Prt2619_VetoresActivity extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        r_p8.setOnCheckedChangeListener(new RadioGroup.OnCheckedChangeListener() {
            @Override
            public void onCheckedChanged(RadioGroup radioGroup, int i) {
                RadioButton na_p8 = (RadioButton) findViewById(R.id.vetores_p8_na);
                RadioButton ad_p8 = (RadioButton) findViewById(R.id.vetores_p8_ad);
                RadioButton in_p8 = (RadioButton) findViewById(R.id.vetores_p8_in);

                ImageButton foto_p8 = (ImageButton) findViewById(R.id.vetores_foto_p8);
                ImageButton descricao_p8 = (ImageButton) findViewById(R.id.vetores_descricao_p8);
