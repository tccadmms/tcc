...
public class Prt78_325_ResponsavelActivity extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        r_p6.setOnCheckedChangeListener(new RadioGroup.OnCheckedChangeListener() {
            @Override
            public void onCheckedChanged(RadioGroup radioGroup, int i) {
                RadioButton na_p6 = (RadioButton) findViewById(R.id.responsavel_p6_na);
                RadioButton ad_p6 = (RadioButton) findViewById(R.id.responsavel_p6_ad);
                RadioButton in_p6 = (RadioButton) findViewById(R.id.responsavel_p6_in);

                ImageButton foto_p6 = (ImageButton) findViewById(R.id.responsavel_foto_p6);
                ImageButton descricao_p6 = (ImageButton) findViewById(R.id.responsavel_descricao_p6);
        ...
        r_p7.setOnCheckedChangeListener(new RadioGroup.OnCheckedChangeListener() {
            @Override
            public void onCheckedChanged(RadioGroup radioGroup, int i) {
                RadioButton na_p7 = (RadioButton) findViewById(R.id.responsavel_p7_na);
                RadioButton ad_p7 = (RadioButton) findViewById(R.id.responsavel_p7_ad);
                RadioButton in_p7 = (RadioButton) findViewById(R.id.responsavel_p7_in);

                ImageButton foto_p7 = (ImageButton) findViewById(R.id.responsavel_foto_p7);
                ImageButton descricao_p7 = (ImageButton) findViewById(R.id.responsavel_descricao_p7);
