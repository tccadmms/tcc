...
public class Rdc216ManipuladorActivity extends Activity {
    ...
    private static final int NUMERO_PERGUNTAS = 13;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        manipuladorSalvar.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                List<ItemAvaliacao> listaItens = ItemAvaliacaoController.buscaItemAvaliacaoPorAreaAvaliada(planoAcao,Constantes.AREA_AVALIADA_MANIPULADORES, Rdc216ManipuladorActivity.this);
                ...
                if (NUMERO_PERGUNTAS != listaItens.size()) {
                    ...
                    AlertDialog.Builder builder = new AlertDialog.Builder(Rdc216ManipuladorActivity.this);
