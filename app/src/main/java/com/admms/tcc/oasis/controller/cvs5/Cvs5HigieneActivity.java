...
public class Cvs5HigieneActivity extends Activity {
    ...
    private static final int NUMERO_PERGUNTAS = 22;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        final Context context = Cvs5HigieneActivity.this;
        ...
        r_p18.setOnCheckedChangeListener(new RadioGroup.OnCheckedChangeListener() {
            ...
            public void onCheckedChanged(RadioGroup radioGroup, int i) {
                ...
                RadioButton in = (RadioButton) findViewById(R.id.higiene_p18_in);

                ImageButton foto = (ImageButton) findViewById(R.id.higiene_foto_p18);
        ...
        r_p19.setOnCheckedChangeListener(new RadioGroup.OnCheckedChangeListener() {
            ...
            public void onCheckedChanged(RadioGroup radioGroup, int i) {
                ...
                RadioButton na = (RadioButton) findViewById(R.id.higiene_p19_na);
                RadioButton ad = (RadioButton) findViewById(R.id.higiene_p19_ad);
                RadioButton in = (RadioButton) findViewById(R.id.higiene_p19_in);

                ImageButton foto = (ImageButton) findViewById(R.id.higiene_foto_p19);
        ...
        r_p20.setOnCheckedChangeListener(new RadioGroup.OnCheckedChangeListener() {
            ...
            public void onCheckedChanged(RadioGroup radioGroup, int i) {
                ...
                RadioButton na = (RadioButton) findViewById(R.id.higiene_p20_na);
                RadioButton ad = (RadioButton) findViewById(R.id.higiene_p20_ad);
                RadioButton in = (RadioButton) findViewById(R.id.higiene_p20_in);

                ImageButton foto = (ImageButton) findViewById(R.id.higiene_foto_p20);
        ...
        r_p21.setOnCheckedChangeListener(new RadioGroup.OnCheckedChangeListener() {
            ...
            public void onCheckedChanged(RadioGroup radioGroup, int i) {
                ...
                RadioButton na = (RadioButton) findViewById(R.id.higiene_p21_na);
                RadioButton ad = (RadioButton) findViewById(R.id.higiene_p21_ad);
                RadioButton in = (RadioButton) findViewById(R.id.higiene_p21_in);

                ImageButton foto = (ImageButton) findViewById(R.id.higiene_foto_p21);
                ImageButton descricao = (ImageButton) findViewById(R.id.higiene_descricao_p21);

                TextView pergunta = (TextView) findViewById(R.id.higiene_pergunta21);
        ...
        r_p22.setOnCheckedChangeListener(new RadioGroup.OnCheckedChangeListener() {
            ...
            public void onCheckedChanged(RadioGroup radioGroup, int i) {
                ...
                RadioButton na = (RadioButton) findViewById(R.id.higiene_p22_na);
                RadioButton ad = (RadioButton) findViewById(R.id.higiene_p22_ad);
                RadioButton in = (RadioButton) findViewById(R.id.higiene_p22_in);

                ImageButton foto = (ImageButton) findViewById(R.id.higiene_foto_p22);
                ImageButton descricao = (ImageButton) findViewById(R.id.higiene_descricao_p22);

                TextView pergunta = (TextView) findViewById(R.id.higiene_pergunta22);
                        ...
                        public void onClick(DialogInterface dialog, int which) {
                            switch (which){
                                case DialogInterface.BUTTON_POSITIVE:
                                    Intent intentVaiProHigiene = new Intent(context, Cvs5Activity.class);
    ...
    private void populateActivity(Context context) {
        ...
        listaRadioButtons.add((RadioButton) findViewById(R.id.higiene_p19_na));
        listaRadioButtons.add((RadioButton) findViewById(R.id.higiene_p19_ad));
        listaRadioButtons.add((RadioButton) findViewById(R.id.higiene_p19_in));
        listaRadioButtons.add((RadioButton) findViewById(R.id.higiene_p20_na));
        listaRadioButtons.add((RadioButton) findViewById(R.id.higiene_p20_ad));
        listaRadioButtons.add((RadioButton) findViewById(R.id.higiene_p20_in));
        listaRadioButtons.add((RadioButton) findViewById(R.id.higiene_p21_na));
        listaRadioButtons.add((RadioButton) findViewById(R.id.higiene_p21_ad));
        listaRadioButtons.add((RadioButton) findViewById(R.id.higiene_p21_in));
        listaRadioButtons.add((RadioButton) findViewById(R.id.higiene_p22_na));
        listaRadioButtons.add((RadioButton) findViewById(R.id.higiene_p22_ad));
        listaRadioButtons.add((RadioButton) findViewById(R.id.higiene_p22_in));
        ...
        listaImageButtons.add((ImageButton) findViewById(R.id.higiene_foto_p19));
        listaImageButtons.add((ImageButton) findViewById(R.id.higiene_descricao_p19));
        listaImageButtons.add((ImageButton) findViewById(R.id.higiene_foto_p20));
        listaImageButtons.add((ImageButton) findViewById(R.id.higiene_descricao_p20));
        listaImageButtons.add((ImageButton) findViewById(R.id.higiene_foto_p21));
        listaImageButtons.add((ImageButton) findViewById(R.id.higiene_descricao_p21));
        listaImageButtons.add((ImageButton) findViewById(R.id.higiene_foto_p22));
        listaImageButtons.add((ImageButton) findViewById(R.id.higiene_descricao_p22));
        ...
        listaTextViews.add((TextView) findViewById(R.id.higiene_pergunta19));
        listaTextViews.add((TextView) findViewById(R.id.higiene_pergunta20));
        listaTextViews.add((TextView) findViewById(R.id.higiene_pergunta21));
        listaTextViews.add((TextView) findViewById(R.id.higiene_pergunta22));
