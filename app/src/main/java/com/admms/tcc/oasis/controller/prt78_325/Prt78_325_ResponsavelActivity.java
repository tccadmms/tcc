...
public class Prt78_325_ResponsavelActivity extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_prt78_325__responsavel);

        final Context context = Prt78_325_ResponsavelActivity.this;
        ...
        RadioGroup r_p6 = (RadioGroup) findViewById(R.id.responsavel_p6);
        ...
        r_p6.setOnCheckedChangeListener(new RadioGroup.OnCheckedChangeListener() {
            ...
            public void onCheckedChanged(RadioGroup radioGroup, int i) {
                ...
                RadioButton na = (RadioButton) findViewById(R.id.responsavel_p6_na);
                RadioButton ad = (RadioButton) findViewById(R.id.responsavel_p6_ad);
                RadioButton in = (RadioButton) findViewById(R.id.responsavel_p6_in);

                ImageButton foto = (ImageButton) findViewById(R.id.responsavel_foto_p6);
                ImageButton descricao = (ImageButton) findViewById(R.id.responsavel_descricao_p6);

                TextView pergunta = (TextView) findViewById(R.id.responsavel_pergunta6);
        ...
        RadioGroup r_p7 = (RadioGroup) findViewById(R.id.responsavel_p7);
        ...
        r_p7.setOnCheckedChangeListener(new RadioGroup.OnCheckedChangeListener() {
            ...
            public void onCheckedChanged(RadioGroup radioGroup, int i) {
                ...
                RadioButton na = (RadioButton) findViewById(R.id.responsavel_p7_na);
                RadioButton ad = (RadioButton) findViewById(R.id.responsavel_p7_ad);
                RadioButton in = (RadioButton) findViewById(R.id.responsavel_p7_in);

                ImageButton foto = (ImageButton) findViewById(R.id.responsavel_foto_p7);
                ImageButton descricao = (ImageButton) findViewById(R.id.responsavel_descricao_p7);

                TextView pergunta = (TextView) findViewById(R.id.responsavel_pergunta7);
                        ...
                        public void onClick(DialogInterface dialog, int which) {
                            switch (which){
                                case DialogInterface.BUTTON_POSITIVE:
                                    Intent intentVaiProResponsavel = new Intent(context, Prt78_325Activity.class);
    ...
    protected void onStart() {
        ...
        listaRadioButtons.add((RadioButton) findViewById(R.id.responsavel_p4_na));
        listaRadioButtons.add((RadioButton) findViewById(R.id.responsavel_p4_ad));
        listaRadioButtons.add((RadioButton) findViewById(R.id.responsavel_p4_in));
        listaRadioButtons.add((RadioButton) findViewById(R.id.responsavel_p5_na));
        listaRadioButtons.add((RadioButton) findViewById(R.id.responsavel_p5_ad));
        listaRadioButtons.add((RadioButton) findViewById(R.id.responsavel_p5_in));
        listaRadioButtons.add((RadioButton) findViewById(R.id.responsavel_p6_na));
        listaRadioButtons.add((RadioButton) findViewById(R.id.responsavel_p6_ad));
        listaRadioButtons.add((RadioButton) findViewById(R.id.responsavel_p6_in));
        listaRadioButtons.add((RadioButton) findViewById(R.id.responsavel_p7_na));
        listaRadioButtons.add((RadioButton) findViewById(R.id.responsavel_p7_ad));
        listaRadioButtons.add((RadioButton) findViewById(R.id.responsavel_p7_in));
        ...
        listaImageButtons.add((ImageButton) findViewById(R.id.responsavel_foto_p4));
        listaImageButtons.add((ImageButton) findViewById(R.id.responsavel_descricao_p4));
        listaImageButtons.add((ImageButton) findViewById(R.id.responsavel_foto_p5));
        listaImageButtons.add((ImageButton) findViewById(R.id.responsavel_descricao_p5));
        listaImageButtons.add((ImageButton) findViewById(R.id.responsavel_foto_p6));
        listaImageButtons.add((ImageButton) findViewById(R.id.responsavel_descricao_p6));
        listaImageButtons.add((ImageButton) findViewById(R.id.responsavel_foto_p7));
        listaImageButtons.add((ImageButton) findViewById(R.id.responsavel_descricao_p7));
        ...
        listaTextViews.add((TextView) findViewById(R.id.responsavel_pergunta4));
        listaTextViews.add((TextView) findViewById(R.id.responsavel_pergunta5));
        listaTextViews.add((TextView) findViewById(R.id.responsavel_pergunta6));
        listaTextViews.add((TextView) findViewById(R.id.responsavel_pergunta7));
