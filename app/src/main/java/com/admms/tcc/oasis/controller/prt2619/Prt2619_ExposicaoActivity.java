...
public class Prt2619_ExposicaoActivity extends Activity {
    ...
    private static final int NUMERO_PERGUNTAS = 39;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        exposicaoSalvar.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                List<ItemAvaliacao> listaItens = ItemAvaliacaoController.buscaItemAvaliacaoPorAreaAvaliada(planoAcao,Constantes.AREA_AVALIADA_EXPOSICAO, context);
                        ...
                        public void onClick(DialogInterface dialog, int which) {
                            switch (which){
                                case DialogInterface.BUTTON_POSITIVE:
                                    Intent intentVaiProExposicao = new Intent(context, Prt2619Activity.class);
                                    intentVaiProExposicao.putExtra("codigoPlanoAcao", codigoPlanoAcao);
                                    intentVaiProExposicao.putExtras(bundle);
    ...
    private void populateActivity(Context context) {
        ...
        listaRadioButtons.add((RadioButton) findViewById(R.id.exposicao_p1_na));
        listaRadioButtons.add((RadioButton) findViewById(R.id.exposicao_p1_ad));
        listaRadioButtons.add((RadioButton) findViewById(R.id.exposicao_p1_in));
        listaRadioButtons.add((RadioButton) findViewById(R.id.exposicao_p2_na));
        listaRadioButtons.add((RadioButton) findViewById(R.id.exposicao_p2_ad));
        listaRadioButtons.add((RadioButton) findViewById(R.id.exposicao_p2_in));
        listaRadioButtons.add((RadioButton) findViewById(R.id.exposicao_p3_na));
        listaRadioButtons.add((RadioButton) findViewById(R.id.exposicao_p3_ad));
        listaRadioButtons.add((RadioButton) findViewById(R.id.exposicao_p3_in));
        listaRadioButtons.add((RadioButton) findViewById(R.id.exposicao_p4_na));
        listaRadioButtons.add((RadioButton) findViewById(R.id.exposicao_p4_ad));
        listaRadioButtons.add((RadioButton) findViewById(R.id.exposicao_p4_in));
        listaRadioButtons.add((RadioButton) findViewById(R.id.exposicao_p5_na));
        listaRadioButtons.add((RadioButton) findViewById(R.id.exposicao_p5_ad));
        listaRadioButtons.add((RadioButton) findViewById(R.id.exposicao_p5_in));
        listaRadioButtons.add((RadioButton) findViewById(R.id.exposicao_p6_na));
        listaRadioButtons.add((RadioButton) findViewById(R.id.exposicao_p6_ad));
        listaRadioButtons.add((RadioButton) findViewById(R.id.exposicao_p6_in));
        listaRadioButtons.add((RadioButton) findViewById(R.id.exposicao_p7_na));
        listaRadioButtons.add((RadioButton) findViewById(R.id.exposicao_p7_ad));
        listaRadioButtons.add((RadioButton) findViewById(R.id.exposicao_p7_in));
        listaRadioButtons.add((RadioButton) findViewById(R.id.exposicao_p8_na));
        listaRadioButtons.add((RadioButton) findViewById(R.id.exposicao_p8_ad));
        listaRadioButtons.add((RadioButton) findViewById(R.id.exposicao_p8_in));
        listaRadioButtons.add((RadioButton) findViewById(R.id.exposicao_p9_na));
        listaRadioButtons.add((RadioButton) findViewById(R.id.exposicao_p9_ad));
        listaRadioButtons.add((RadioButton) findViewById(R.id.exposicao_p9_in));
        listaRadioButtons.add((RadioButton) findViewById(R.id.exposicao_p10_na));
        listaRadioButtons.add((RadioButton) findViewById(R.id.exposicao_p10_ad));
        listaRadioButtons.add((RadioButton) findViewById(R.id.exposicao_p10_in));
        listaRadioButtons.add((RadioButton) findViewById(R.id.exposicao_p11_na));
        listaRadioButtons.add((RadioButton) findViewById(R.id.exposicao_p11_ad));
        listaRadioButtons.add((RadioButton) findViewById(R.id.exposicao_p11_in));
        listaRadioButtons.add((RadioButton) findViewById(R.id.exposicao_p12_na));
        listaRadioButtons.add((RadioButton) findViewById(R.id.exposicao_p12_ad));
        listaRadioButtons.add((RadioButton) findViewById(R.id.exposicao_p12_in));
        listaRadioButtons.add((RadioButton) findViewById(R.id.exposicao_p13_na));
        listaRadioButtons.add((RadioButton) findViewById(R.id.exposicao_p13_ad));
        listaRadioButtons.add((RadioButton) findViewById(R.id.exposicao_p13_in));
        listaRadioButtons.add((RadioButton) findViewById(R.id.exposicao_p14_na));
        listaRadioButtons.add((RadioButton) findViewById(R.id.exposicao_p14_ad));
        listaRadioButtons.add((RadioButton) findViewById(R.id.exposicao_p14_in));
        listaRadioButtons.add((RadioButton) findViewById(R.id.exposicao_p15_na));
        listaRadioButtons.add((RadioButton) findViewById(R.id.exposicao_p15_ad));
        listaRadioButtons.add((RadioButton) findViewById(R.id.exposicao_p15_in));
        listaRadioButtons.add((RadioButton) findViewById(R.id.exposicao_p16_na));
        listaRadioButtons.add((RadioButton) findViewById(R.id.exposicao_p16_ad));
        listaRadioButtons.add((RadioButton) findViewById(R.id.exposicao_p16_in));
        listaRadioButtons.add((RadioButton) findViewById(R.id.exposicao_p17_na));
        listaRadioButtons.add((RadioButton) findViewById(R.id.exposicao_p17_ad));
        listaRadioButtons.add((RadioButton) findViewById(R.id.exposicao_p17_in));
        listaRadioButtons.add((RadioButton) findViewById(R.id.exposicao_p18_na));
        listaRadioButtons.add((RadioButton) findViewById(R.id.exposicao_p18_ad));
        listaRadioButtons.add((RadioButton) findViewById(R.id.exposicao_p18_in));
        listaRadioButtons.add((RadioButton) findViewById(R.id.exposicao_p19_na));
        listaRadioButtons.add((RadioButton) findViewById(R.id.exposicao_p19_ad));
        listaRadioButtons.add((RadioButton) findViewById(R.id.exposicao_p19_in));
        listaRadioButtons.add((RadioButton) findViewById(R.id.exposicao_p20_na));
        listaRadioButtons.add((RadioButton) findViewById(R.id.exposicao_p20_ad));
        listaRadioButtons.add((RadioButton) findViewById(R.id.exposicao_p20_in));
        listaRadioButtons.add((RadioButton) findViewById(R.id.exposicao_p21_na));
        listaRadioButtons.add((RadioButton) findViewById(R.id.exposicao_p21_ad));
        listaRadioButtons.add((RadioButton) findViewById(R.id.exposicao_p21_in));
        listaRadioButtons.add((RadioButton) findViewById(R.id.exposicao_p22_na));
        listaRadioButtons.add((RadioButton) findViewById(R.id.exposicao_p22_ad));
        listaRadioButtons.add((RadioButton) findViewById(R.id.exposicao_p22_in));
        listaRadioButtons.add((RadioButton) findViewById(R.id.exposicao_p23_na));
        listaRadioButtons.add((RadioButton) findViewById(R.id.exposicao_p23_ad));
        listaRadioButtons.add((RadioButton) findViewById(R.id.exposicao_p23_in));
        listaRadioButtons.add((RadioButton) findViewById(R.id.exposicao_p24_na));
        listaRadioButtons.add((RadioButton) findViewById(R.id.exposicao_p24_ad));
        listaRadioButtons.add((RadioButton) findViewById(R.id.exposicao_p24_in));
        listaRadioButtons.add((RadioButton) findViewById(R.id.exposicao_p25_na));
        listaRadioButtons.add((RadioButton) findViewById(R.id.exposicao_p25_ad));
        listaRadioButtons.add((RadioButton) findViewById(R.id.exposicao_p25_in));
        listaRadioButtons.add((RadioButton) findViewById(R.id.exposicao_p26_na));
        listaRadioButtons.add((RadioButton) findViewById(R.id.exposicao_p26_ad));
        listaRadioButtons.add((RadioButton) findViewById(R.id.exposicao_p26_in));
        listaRadioButtons.add((RadioButton) findViewById(R.id.exposicao_p27_na));
        listaRadioButtons.add((RadioButton) findViewById(R.id.exposicao_p27_ad));
        listaRadioButtons.add((RadioButton) findViewById(R.id.exposicao_p27_in));
        listaRadioButtons.add((RadioButton) findViewById(R.id.exposicao_p28_na));
        listaRadioButtons.add((RadioButton) findViewById(R.id.exposicao_p28_ad));
        listaRadioButtons.add((RadioButton) findViewById(R.id.exposicao_p28_in));
        listaRadioButtons.add((RadioButton) findViewById(R.id.exposicao_p29_na));
        listaRadioButtons.add((RadioButton) findViewById(R.id.exposicao_p29_ad));
        listaRadioButtons.add((RadioButton) findViewById(R.id.exposicao_p29_in));
        listaRadioButtons.add((RadioButton) findViewById(R.id.exposicao_p30_na));
        listaRadioButtons.add((RadioButton) findViewById(R.id.exposicao_p30_ad));
        listaRadioButtons.add((RadioButton) findViewById(R.id.exposicao_p30_in));
        listaRadioButtons.add((RadioButton) findViewById(R.id.exposicao_p31_na));
        listaRadioButtons.add((RadioButton) findViewById(R.id.exposicao_p31_ad));
        listaRadioButtons.add((RadioButton) findViewById(R.id.exposicao_p31_in));
        listaRadioButtons.add((RadioButton) findViewById(R.id.exposicao_p32_na));
        listaRadioButtons.add((RadioButton) findViewById(R.id.exposicao_p32_ad));
        listaRadioButtons.add((RadioButton) findViewById(R.id.exposicao_p32_in));
        listaRadioButtons.add((RadioButton) findViewById(R.id.exposicao_p33_na));
        listaRadioButtons.add((RadioButton) findViewById(R.id.exposicao_p33_ad));
        listaRadioButtons.add((RadioButton) findViewById(R.id.exposicao_p33_in));
        listaRadioButtons.add((RadioButton) findViewById(R.id.exposicao_p34_na));
        listaRadioButtons.add((RadioButton) findViewById(R.id.exposicao_p34_ad));
        listaRadioButtons.add((RadioButton) findViewById(R.id.exposicao_p34_in));
        listaRadioButtons.add((RadioButton) findViewById(R.id.exposicao_p35_na));
        listaRadioButtons.add((RadioButton) findViewById(R.id.exposicao_p35_ad));
        listaRadioButtons.add((RadioButton) findViewById(R.id.exposicao_p35_in));
        listaRadioButtons.add((RadioButton) findViewById(R.id.exposicao_p36_na));
        listaRadioButtons.add((RadioButton) findViewById(R.id.exposicao_p36_ad));
        listaRadioButtons.add((RadioButton) findViewById(R.id.exposicao_p36_in));
        listaRadioButtons.add((RadioButton) findViewById(R.id.exposicao_p37_na));
        listaRadioButtons.add((RadioButton) findViewById(R.id.exposicao_p37_ad));
        listaRadioButtons.add((RadioButton) findViewById(R.id.exposicao_p37_in));
        listaRadioButtons.add((RadioButton) findViewById(R.id.exposicao_p38_na));
        listaRadioButtons.add((RadioButton) findViewById(R.id.exposicao_p38_ad));
        listaRadioButtons.add((RadioButton) findViewById(R.id.exposicao_p38_in));
        listaRadioButtons.add((RadioButton) findViewById(R.id.exposicao_p39_na));
        listaRadioButtons.add((RadioButton) findViewById(R.id.exposicao_p39_ad));
        listaRadioButtons.add((RadioButton) findViewById(R.id.exposicao_p39_in));

        listaImageButtons.add((ImageButton) findViewById(R.id.exposicao_foto_p1));
        listaImageButtons.add((ImageButton) findViewById(R.id.exposicao_descricao_p1));
        listaImageButtons.add((ImageButton) findViewById(R.id.exposicao_foto_p2));
        listaImageButtons.add((ImageButton) findViewById(R.id.exposicao_descricao_p2));
        listaImageButtons.add((ImageButton) findViewById(R.id.exposicao_foto_p3));
        listaImageButtons.add((ImageButton) findViewById(R.id.exposicao_descricao_p3));
        listaImageButtons.add((ImageButton) findViewById(R.id.exposicao_foto_p4));
        listaImageButtons.add((ImageButton) findViewById(R.id.exposicao_descricao_p4));
        listaImageButtons.add((ImageButton) findViewById(R.id.exposicao_foto_p5));
        listaImageButtons.add((ImageButton) findViewById(R.id.exposicao_descricao_p5));
        listaImageButtons.add((ImageButton) findViewById(R.id.exposicao_foto_p6));
        listaImageButtons.add((ImageButton) findViewById(R.id.exposicao_descricao_p6));
        listaImageButtons.add((ImageButton) findViewById(R.id.exposicao_foto_p7));
        listaImageButtons.add((ImageButton) findViewById(R.id.exposicao_descricao_p7));
        listaImageButtons.add((ImageButton) findViewById(R.id.exposicao_foto_p8));
        listaImageButtons.add((ImageButton) findViewById(R.id.exposicao_descricao_p8));
        listaImageButtons.add((ImageButton) findViewById(R.id.exposicao_foto_p9));
        listaImageButtons.add((ImageButton) findViewById(R.id.exposicao_descricao_p9));
        listaImageButtons.add((ImageButton) findViewById(R.id.exposicao_foto_p10));
        listaImageButtons.add((ImageButton) findViewById(R.id.exposicao_descricao_p10));
        listaImageButtons.add((ImageButton) findViewById(R.id.exposicao_foto_p11));
        listaImageButtons.add((ImageButton) findViewById(R.id.exposicao_descricao_p11));
        listaImageButtons.add((ImageButton) findViewById(R.id.exposicao_foto_p12));
        listaImageButtons.add((ImageButton) findViewById(R.id.exposicao_descricao_p12));
        listaImageButtons.add((ImageButton) findViewById(R.id.exposicao_foto_p13));
        listaImageButtons.add((ImageButton) findViewById(R.id.exposicao_descricao_p13));
        listaImageButtons.add((ImageButton) findViewById(R.id.exposicao_foto_p14));
        listaImageButtons.add((ImageButton) findViewById(R.id.exposicao_descricao_p14));
        listaImageButtons.add((ImageButton) findViewById(R.id.exposicao_foto_p15));
        listaImageButtons.add((ImageButton) findViewById(R.id.exposicao_descricao_p15));
        listaImageButtons.add((ImageButton) findViewById(R.id.exposicao_foto_p16));
        listaImageButtons.add((ImageButton) findViewById(R.id.exposicao_descricao_p16));
        listaImageButtons.add((ImageButton) findViewById(R.id.exposicao_foto_p17));
        listaImageButtons.add((ImageButton) findViewById(R.id.exposicao_descricao_p17));
        listaImageButtons.add((ImageButton) findViewById(R.id.exposicao_foto_p18));
        listaImageButtons.add((ImageButton) findViewById(R.id.exposicao_descricao_p18));
        listaImageButtons.add((ImageButton) findViewById(R.id.exposicao_foto_p19));
        listaImageButtons.add((ImageButton) findViewById(R.id.exposicao_descricao_p19));
        listaImageButtons.add((ImageButton) findViewById(R.id.exposicao_foto_p20));
        listaImageButtons.add((ImageButton) findViewById(R.id.exposicao_descricao_p20));
        listaImageButtons.add((ImageButton) findViewById(R.id.exposicao_foto_p21));
        listaImageButtons.add((ImageButton) findViewById(R.id.exposicao_descricao_p21));
        listaImageButtons.add((ImageButton) findViewById(R.id.exposicao_foto_p22));
        listaImageButtons.add((ImageButton) findViewById(R.id.exposicao_descricao_p22));
        listaImageButtons.add((ImageButton) findViewById(R.id.exposicao_foto_p23));
        listaImageButtons.add((ImageButton) findViewById(R.id.exposicao_descricao_p23));
        listaImageButtons.add((ImageButton) findViewById(R.id.exposicao_foto_p24));
        listaImageButtons.add((ImageButton) findViewById(R.id.exposicao_descricao_p24));
        listaImageButtons.add((ImageButton) findViewById(R.id.exposicao_foto_p25));
        listaImageButtons.add((ImageButton) findViewById(R.id.exposicao_descricao_p25));
        listaImageButtons.add((ImageButton) findViewById(R.id.exposicao_foto_p26));
        listaImageButtons.add((ImageButton) findViewById(R.id.exposicao_descricao_p26));
        listaImageButtons.add((ImageButton) findViewById(R.id.exposicao_foto_p27));
        listaImageButtons.add((ImageButton) findViewById(R.id.exposicao_descricao_p27));
        listaImageButtons.add((ImageButton) findViewById(R.id.exposicao_foto_p28));
        listaImageButtons.add((ImageButton) findViewById(R.id.exposicao_descricao_p28));
        listaImageButtons.add((ImageButton) findViewById(R.id.exposicao_foto_p29));
        listaImageButtons.add((ImageButton) findViewById(R.id.exposicao_descricao_p29));
        listaImageButtons.add((ImageButton) findViewById(R.id.exposicao_foto_p30));
        listaImageButtons.add((ImageButton) findViewById(R.id.exposicao_descricao_p30));
        listaImageButtons.add((ImageButton) findViewById(R.id.exposicao_foto_p31));
        listaImageButtons.add((ImageButton) findViewById(R.id.exposicao_descricao_p31));
        listaImageButtons.add((ImageButton) findViewById(R.id.exposicao_foto_p32));
        listaImageButtons.add((ImageButton) findViewById(R.id.exposicao_descricao_p32));
        listaImageButtons.add((ImageButton) findViewById(R.id.exposicao_foto_p33));
        listaImageButtons.add((ImageButton) findViewById(R.id.exposicao_descricao_p33));
        listaImageButtons.add((ImageButton) findViewById(R.id.exposicao_foto_p34));
        listaImageButtons.add((ImageButton) findViewById(R.id.exposicao_descricao_p34));
        listaImageButtons.add((ImageButton) findViewById(R.id.exposicao_foto_p35));
        listaImageButtons.add((ImageButton) findViewById(R.id.exposicao_descricao_p35));
        listaImageButtons.add((ImageButton) findViewById(R.id.exposicao_foto_p36));
        listaImageButtons.add((ImageButton) findViewById(R.id.exposicao_descricao_p36));
        listaImageButtons.add((ImageButton) findViewById(R.id.exposicao_foto_p37));
        listaImageButtons.add((ImageButton) findViewById(R.id.exposicao_descricao_p37));
        listaImageButtons.add((ImageButton) findViewById(R.id.exposicao_foto_p38));
        listaImageButtons.add((ImageButton) findViewById(R.id.exposicao_descricao_p38));
        listaImageButtons.add((ImageButton) findViewById(R.id.exposicao_foto_p39));
        listaImageButtons.add((ImageButton) findViewById(R.id.exposicao_descricao_p39));

        listaTextViews.add((TextView) findViewById(R.id.exposicao_pergunta1));
        listaTextViews.add((TextView) findViewById(R.id.exposicao_pergunta2));
        listaTextViews.add((TextView) findViewById(R.id.exposicao_pergunta3));
        listaTextViews.add((TextView) findViewById(R.id.exposicao_pergunta4));
        listaTextViews.add((TextView) findViewById(R.id.exposicao_pergunta5));
        listaTextViews.add((TextView) findViewById(R.id.exposicao_pergunta6));
        listaTextViews.add((TextView) findViewById(R.id.exposicao_pergunta7));
        listaTextViews.add((TextView) findViewById(R.id.exposicao_pergunta8));
        listaTextViews.add((TextView) findViewById(R.id.exposicao_pergunta9));
        listaTextViews.add((TextView) findViewById(R.id.exposicao_pergunta10));
        listaTextViews.add((TextView) findViewById(R.id.exposicao_pergunta11));
        listaTextViews.add((TextView) findViewById(R.id.exposicao_pergunta12));
        listaTextViews.add((TextView) findViewById(R.id.exposicao_pergunta13));
        listaTextViews.add((TextView) findViewById(R.id.exposicao_pergunta14));
        listaTextViews.add((TextView) findViewById(R.id.exposicao_pergunta15));
        listaTextViews.add((TextView) findViewById(R.id.exposicao_pergunta16));
        listaTextViews.add((TextView) findViewById(R.id.exposicao_pergunta17));
        listaTextViews.add((TextView) findViewById(R.id.exposicao_pergunta18));
        listaTextViews.add((TextView) findViewById(R.id.exposicao_pergunta19));
        listaTextViews.add((TextView) findViewById(R.id.exposicao_pergunta20));
        listaTextViews.add((TextView) findViewById(R.id.exposicao_pergunta21));
        listaTextViews.add((TextView) findViewById(R.id.exposicao_pergunta22));
        listaTextViews.add((TextView) findViewById(R.id.exposicao_pergunta23));
        listaTextViews.add((TextView) findViewById(R.id.exposicao_pergunta24));
        listaTextViews.add((TextView) findViewById(R.id.exposicao_pergunta25));
        listaTextViews.add((TextView) findViewById(R.id.exposicao_pergunta26));
        listaTextViews.add((TextView) findViewById(R.id.exposicao_pergunta27));
        listaTextViews.add((TextView) findViewById(R.id.exposicao_pergunta28));
        listaTextViews.add((TextView) findViewById(R.id.exposicao_pergunta29));
        listaTextViews.add((TextView) findViewById(R.id.exposicao_pergunta30));
        listaTextViews.add((TextView) findViewById(R.id.exposicao_pergunta31));
        listaTextViews.add((TextView) findViewById(R.id.exposicao_pergunta32));
        listaTextViews.add((TextView) findViewById(R.id.exposicao_pergunta33));
        listaTextViews.add((TextView) findViewById(R.id.exposicao_pergunta34));
        listaTextViews.add((TextView) findViewById(R.id.exposicao_pergunta35));
        listaTextViews.add((TextView) findViewById(R.id.exposicao_pergunta36));
        listaTextViews.add((TextView) findViewById(R.id.exposicao_pergunta37));
        listaTextViews.add((TextView) findViewById(R.id.exposicao_pergunta38));
        listaTextViews.add((TextView) findViewById(R.id.exposicao_pergunta39));
