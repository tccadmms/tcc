...
public class ArmazenamentoActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_armazenamento);
        ...
        armazenamentoSalvar.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent intentVaiProArmazenamento = new Intent(ArmazenamentoActivity.this, ItensDeAvaliacaoActivity.class);
    ...
    protected void mostraJanelaDescricao() {
        ...
        LayoutInflater layoutInflater = LayoutInflater.from(ArmazenamentoActivity.this);
        View promptView = layoutInflater.inflate(R.layout.activity_pop_up, null);
        AlertDialog.Builder alertDialogBuilder = new AlertDialog.Builder(ArmazenamentoActivity.this);
