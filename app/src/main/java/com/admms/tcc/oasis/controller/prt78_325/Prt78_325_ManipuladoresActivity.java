...
public class Prt78_325_ManipuladoresActivity extends Activity {

    private ItemAvaliacao itemAvaliacao;
    private static final int REQUEST_IMAGE_PICTURE = 1;
    private static final int NUMERO_PERGUNTAS = 16;

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_prt78_325__manipuladores);
        ...
        r_p1.setOnCheckedChangeListener(new RadioGroup.OnCheckedChangeListener() {
            ...
            public void onCheckedChanged(RadioGroup radioGroup, int i) {
                ...
                ItemAvaliacaoController.salvarItemAvaliacao(itemAvaliacao, Prt78_325_ManipuladoresActivity.this);
            }
        });
        ...
        manipuladoresSalvar.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                List<ItemAvaliacao> listaItens = ItemAvaliacaoController.buscaItemAvaliacaoPorAreaAvaliada(planoAcao,Constantes.AREA_AVALIADA_MANIPULADORES, Prt78_325_ManipuladoresActivity.this);
                ...
                if (NUMERO_PERGUNTAS != listaItens.size()) {
                        ...
                        public void onClick(DialogInterface dialog, int which) {
                            switch (which){
                                case DialogInterface.BUTTON_POSITIVE:
                                    Intent intentVaiProManipuladores = new Intent(Prt78_325_ManipuladoresActivity.this, Prt78_325Activity.class);
                    ...
                    AlertDialog.Builder builder = new AlertDialog.Builder(Prt78_325_ManipuladoresActivity.this);
    ...
    protected void mostraJanelaDescricao(final ItemAvaliacao itemAvaliacao) {
        ...
        LayoutInflater layoutInflater = LayoutInflater.from(Prt78_325_ManipuladoresActivity.this);
        View promptView = layoutInflater.inflate(R.layout.activity_pop_up, null);
        AlertDialog.Builder alertDialogBuilder = new AlertDialog.Builder(Prt78_325_ManipuladoresActivity.this);
