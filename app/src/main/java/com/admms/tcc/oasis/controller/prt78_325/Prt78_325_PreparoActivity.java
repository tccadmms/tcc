...
public class Prt78_325_PreparoActivity extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        preparoSalvar.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent intentVaiProPreparo = new Intent(Prt78_325_PreparoActivity.this, Prt78_325Activity.class);
    ...
    protected void mostraJanelaDescricao() {
        ...
        LayoutInflater layoutInflater = LayoutInflater.from(Prt78_325_PreparoActivity.this);
        View promptView = layoutInflater.inflate(R.layout.activity_pop_up, null);
        AlertDialog.Builder alertDialogBuilder = new AlertDialog.Builder(Prt78_325_PreparoActivity.this);
