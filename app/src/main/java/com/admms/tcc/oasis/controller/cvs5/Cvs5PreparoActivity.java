...
public class Cvs5PreparoActivity extends Activity {
    ...
    private static final int NUMERO_PERGUNTAS = 27;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        final Context context = Cvs5PreparoActivity.this;
                        ...
                        public void onClick(DialogInterface dialog, int which) {
                            switch (which){
                                case DialogInterface.BUTTON_POSITIVE:
                                    Intent intentVaiProPreparo = new Intent(context, Cvs5Activity.class);
